...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Edit Data Instansi','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Data Instansi','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                ['label' => 'Daftar Instansi', 'url' => route('admin.instansi.index')],
                ['label' => 'Edit']
            ])]); ?>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900/50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <form action="<?php echo e(route('admin.instansi.update', $instansi->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center gap-3 mb-8 pb-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-800 dark:text-gray-200"><?php echo e($instansi->nama_dinas); ?></h3>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_dinas" value="<?php echo e(old('nama_dinas', $instansi->nama_dinas)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="kode_unit_kerja" value="<?php echo e(old('kode_unit_kerja', $instansi->kode_unit_kerja)); ?>"
                                        class="w-full pl-10 pr-4 py-3 rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:border-teal-500 focus:ring focus:ring-teal-200 transition shadow-sm" required
                                        oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                        oninput="this.setCustomValidity('')">
                                </div>
                                <?php $__errorArgs = ['kode_unit_kerja'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea name="alamat" rows="4"
                                        ...
                                        required
                                        oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                        oninput="this.setCustomValidity('')"><?php echo e(old('alamat', $instansi->alamat)); ?></textarea>
                                        ...
                                        <?php if($instansi->ttd_kepala): ?>
                                            <div class="relative group">
                                                <div class="w-24 h-24 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center bg-white dark:bg-gray-800 overflow-hidden p-1">
                                                    <img src="<?php echo e(asset('storage/' . $instansi->ttd_kepala)); ?>" alt="TTD Preview" class="max-h-full max-w-full object-contain">
                                                </div>
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="email" name="email_admin" value="<?php echo e(old('email_admin', $adminUser->email ?? '')); ?>" 
                                                class="w-full pl-10 pr-4 py-2.5 rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:border-teal-500 focus:ring focus:ring-teal-200 transition shadow-sm" <?php if($adminUser): echo 'required'; endif; ?>
                                                oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                                oninput="this.setCustomValidity('')">
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <?php $__errorArgs = ['password_admin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs mt-1"><?php echo e($message); ?></span> <?php unset($message);
                    ...
                    <div class="mt-8 bg-blue-50/50 dark:bg-blue-950/20 p-5 rounded-xl border border-blue-100 dark:border-blue-900/50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="relative">
                                ...
                                <input type="text" name="latitude" id="latitude" value="<?php echo e(old('latitude', $instansi->latitude)); ?>"
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="longitude" id="longitude" value="<?php echo e(old('longitude', $instansi->longitude)); ?>"
                                    class="w-full pl-10 pr-4 py-2 rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 focus:border-teal-500 focus:ring-teal-200 text-sm" required
                                    oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                    oninput="this.setCustomValidity('')">
                            </div>
                            <div class="relative">
                                ...
                                <input type="number" name="radius_absen" id="radius_absen" value="<?php echo e(old('radius_absen', $instansi->radius_absen ?? 50)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end sm:space-x-3 mt-10 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <a href="<?php echo e(route('admin.instansi.index')); ?>" class="w-full sm:w-auto px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-50 dark:hover:bg-gray-900 transition shadow-sm text-center">
                            Batal
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\instansi\edit.blade.php ENDPATH**/ ?>