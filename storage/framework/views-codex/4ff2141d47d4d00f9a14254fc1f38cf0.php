...
<div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 flex flex-col justify-between stagger-2">
    <div>
        ...
        <div class="flex items-center gap-3 sm:gap-4 mb-3">
            <div class="relative w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0">
                <svg viewBox="0 0 80 80" class="w-16 h-16 sm:w-20 sm:h-20 -rotate-90">
                    ...
                    <circle cx="40" cy="40" r="32" fill="none" stroke="#14b8a6" stroke-width="8"
                        ...
                        stroke-dashoffset="<?php echo e($hadirOffset); ?>"
                        style="transition: stroke-dashoffset 1.4s cubic-bezier(0.22,1,0.36,1);"/>
                </svg>
                <div class="absolute inset-0 flex flex-col items-center justify-center rotate-90">
                    <span class="text-base sm:text-lg font-black text-teal-600 dark:text-teal-400 font-mono leading-none"><?php echo e($stats['attendance']['hadir']); ?></span>
            ...
            <div class="grid grid-cols-1 gap-2 sm:gap-1.5 flex-1 text-xs">
                <div class="flex items-center justify-between">
                    ...
                    <span class="font-black text-emerald-600 dark:text-emerald-400 font-mono"><?php echo e($stats['attendance']['hadir']); ?></span>
                </div>
                <div class="flex items-center justify-between">
                    ...
                    <span class="font-black text-amber-600 dark:text-amber-400 font-mono"><?php echo e($stats['attendance']['izin'] + ($stats['attendance']['sakit'] ?? 0)); ?></span>
                </div>
                <div class="flex items-center justify-between">
                    ...
                    <span class="font-black text-rose-600 dark:text-rose-400 font-mono"><?php echo e($stats['attendance']['alpa']); ?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="mt-2 pt-3 border-t border-gray-100 dark:border-gray-700 text-center">
        <a href="<?php echo e(route('peserta.absensi.index')); ?>" class="inline-flex items-center gap-1.5 min-h-[44px] text-xs font-bold text-teal-600 hover:text-teal-800 dark:text-teal-400 dark:hover:text-teal-300 transition">
            <i class="fas fa-history"></i> Lihat Riwayat Absen &rarr;
        </a>
    </div>
</div>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/peserta/dashboard/_absensi-card.blade.php ENDPATH**/ ?>