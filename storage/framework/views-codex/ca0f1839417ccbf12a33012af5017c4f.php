...
<body>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="sep-col">:</td>
            <td><?php echo e($app->pembimbing_lapangan->name ?? '.........................'); ?></td>
        </tr>
        <tr>
            <td class="label-col">Instansi Kerja Praktek</td>
            <td class="sep-col">:</td>
            <td>
                <?php echo e($app->position->instansi->nama_dinas); ?><br>
                Banjarmasin
            </td>
        </tr>
    </table>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="sep-col">:</td>
            <td class="text-bold"><?php echo e($app->user->name); ?></td>
        </tr>
        <tr>
            <td class="label-col">Nomor Pokok Mahasiswa (NPM)</td>
            <td class="sep-col">:</td>
            <td><?php echo e($app->user->nim ?? '2210010154'); ?></td> 
        </tr>
        <tr>
            <td class="label-col">Waktu Pelaksanaan</td>
            <td class="sep-col">:</td>
            <td>
                <?php echo e(\Carbon\Carbon::parse($app->tanggal_mulai)->translatedFormat('d F Y')); ?> – 
                <?php echo e(\Carbon\Carbon::parse($app->tanggal_selesai)->translatedFormat('d F Y')); ?>
    ...
    <table class="grade-table">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $kriteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $nilai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="col-no"><?php echo e($no++); ?></td>
                <td><?php echo e($label); ?></td>
                <td class="col-nilai"><?php echo e($nilai); ?></td>
            </tr>
    ...
    <div style="text-align: right; margin-bottom: 5px;">
        Banjarmasin, <?php echo e(\Carbon\Carbon::now()->translatedFormat('d F Y')); ?>
    ...
    <table class="signature-table">
        <tr>
            <td width="50%">
                Mengetahui,<br>
                <span style="font-weight: bold;"><?php echo e($app->position->instansi->jabatan_pejabat ?? 'Kepala Dinas'); ?></span><br>
                <?php echo e($app->position->instansi->nama_dinas); ?>

                
                
                    <?php if($app->position->instansi->ttd_kepala && file_exists(public_path('storage/' . $app->position->instansi->ttd_kepala))): ?>
                        <img src="<?php echo e(public_path('storage/' . $app->position->instansi->ttd_kepala)); ?>" style="height: 60px; width: auto;">
                    <?php endif; ?>
                <div class="sign-space"></div> <span class="text-bold" style="text-decoration: underline;">
                    <?php echo e($app->position->instansi->nama_pejabat ?? '........................................'); ?>

                </span><br>
                NIP. <?php echo e($app->position->instansi->nip_pejabat ?? '....................'); ?>
            ...
            <td width="50%">
                Pembimbing Lapangan<br> <br>
                    ...
                    <?php endif; ?>
                <div class="sign-space"></div> <span class="text-bold" style="text-decoration: underline;"><?php echo e($app->pembimbing_lapangan->name); ?></span><br>
                NIP. ...........................
            </td>
        </tr>
    </table>
...
</html><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\peserta\transkrip_nilai.blade.php ENDPATH**/ ?>