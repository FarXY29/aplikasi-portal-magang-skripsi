    ...
    <div class="max-w-5xl mx-auto w-full">
        <div class="grid grid-cols-3 gap-3.5 sm:gap-6 w-full">
            ...
            <div class="bg-white dark:bg-gray-800/95 backdrop-blur-md p-4 sm:p-7 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100/80 dark:border-gray-700/50 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-3.5 sm:gap-5 transform hover:-translate-y-1.5 transition-all duration-300 group">
                ...
                <div class="min-w-0">
                    <div class="text-xl sm:text-3xl font-black text-slate-800 dark:text-white tracking-tight truncate leading-none sm:leading-tight font-display"><?php echo e($totalInstansi); ?></div>
                    <div class="text-slate-400 dark:text-slate-500 text-[10px] sm:text-xs font-bold uppercase tracking-wider mt-1.5 truncate">Instansi Aktif</div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800/95 backdrop-blur-md p-4 sm:p-7 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100/80 dark:border-gray-700/50 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-3.5 sm:gap-5 transform hover:-translate-y-1.5 transition-all duration-300 group">
                ...
                <div class="min-w-0">
                    <div class="text-xl sm:text-3xl font-black text-slate-800 dark:text-white tracking-tight truncate leading-none sm:leading-tight font-display"><?php echo e($totalLowongan); ?></div>
            ...
            <div class="bg-white dark:bg-gray-800/95 backdrop-blur-md p-4 sm:p-7 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100/80 dark:border-gray-700/50 flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-3.5 sm:gap-5 transform hover:-translate-y-1.5 transition-all duration-300 group">
                ...
                <div class="min-w-0">
                    <div class="text-xl sm:text-3xl font-black text-slate-800 dark:text-white tracking-tight truncate leading-none sm:leading-tight font-display"><?php echo e($totalAlumni); ?></div>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/public/welcome/_stats.blade.php ENDPATH**/ ?>