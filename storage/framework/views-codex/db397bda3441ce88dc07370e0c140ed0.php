     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-2">
                ...
                <?php echo e(__('Kelola Pembimbing Lapangan')); ?>
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 font-medium bg-white dark:bg-gray-800 px-4 py-1.5 rounded-full shadow-sm border border-gray-100 dark:border-gray-700">
                Total Pembimbing Lapangan: <span class="font-bold text-teal-600 dark:text-teal-400"><?php echo e($pembimbing_lapangan->count()); ?></span>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div class="w-full lg:w-1/3 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 sticky top-8">
                    <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div>
                            <h3 class="font-bold text-gray-800 dark:text-gray-200">Tambah Pembimbing Lapangan Baru</h3>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Buat akun untuk pegawai pembimbing.</p>
                        </div>
                    </div>

                    <form action="<?php echo e(route('dinas.pembimbing_lapangan.store')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-900">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kontak</th>
                            ...
                            <tbody class="divide-y divide-gray-50 dark:divide-gray-700/60 bg-white dark:bg-gray-800">
                                <?php $__empty_1 = true; $__currentLoopData = $pembimbing_lapangan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembimbing_lapangan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition group">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-sm">
                                                <?php echo e(strtoupper(substr($pembimbing_lapangan->name, 0, 1))); ?>

                                            </div>
                                            <div>
                                                <div class="text-sm font-bold text-gray-900 dark:text-gray-100"><?php echo e($pembimbing_lapangan->name); ?></div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400 font-mono bg-gray-100 dark:bg-gray-900 px-1.5 rounded w-fit mt-0.5 border border-transparent dark:border-gray-700">
                                                    NIP: <?php echo e($pembimbing_lapangan->nik ?? '-'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                                        <div class="flex items-center gap-2">
                                            <i class="far fa-envelope text-gray-400 dark:text-gray-500"></i> <?php echo e($pembimbing_lapangan->email); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-200">
                                            ...
                                            <form action="<?php echo e(route('dinas.pembimbing_lapangan.destroy', $pembimbing_lapangan->id)); ?>" method="POST" @submit.prevent="$dispatch('open-confirm', { message: 'Hapus akun ini? Pembimbing ini akan hilang dari data peserta yang dibimbingnya.', onConfirm: () => $el.submit() })">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_instansi\pembimbing_lapangan\index.blade.php ENDPATH**/ ?>