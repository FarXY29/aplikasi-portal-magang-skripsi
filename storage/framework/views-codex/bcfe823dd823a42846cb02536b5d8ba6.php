     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Pemantauan Logbook Mahasiswa')); ?>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 p-5 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <form action="<?php echo e(route('pembimbing.peserta.logbook', $app->id)); ?>" method="GET" class="w-full md:w-auto flex flex-wrap items-center gap-4">
                    ...
                    <?php if(request('filter_type') && request('filter_type') != 'semua'): ?>
                        <a href="<?php echo e(route('pembimbing.peserta.logbook', $app->id)); ?>" class="p-2 bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-300 hover:bg-rose-100 border border-rose-200 dark:border-rose-800/60 rounded-xl transition text-xs font-bold flex items-center gap-1.5">
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-start" x-data="{ activeTab: <?php echo e($logs->first()->id); ?> }">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden sticky top-8">
                            ...
                            <div class="max-h-[70vh] overflow-y-auto custom-scrollbar">
                                <ul class="divide-y divide-gray-100 dark:divide-gray-700/60">
                                    ...
                                    <li>
                                        <button @click="activeTab = <?php echo e($log->id); ?>"
                                            :class="{ 'bg-teal-50/70 dark:bg-teal-950/40 border-l-4 border-teal-500 dark:border-teal-400': activeTab === <?php echo e($log->id); ?>, 'border-l-4 border-transparent hover:bg-gray-50 dark:hover:bg-gray-900/60': activeTab !== <?php echo e($log->id); ?> }"
                                            class="w-full text-left px-4 py-3 transition duration-150 ease-in-out focus:outline-none group">
                                            
                                            <div class="flex justify-between items-start mb-1">
                                                <span class="text-xs font-bold text-gray-800 dark:text-gray-200" :class="{ 'text-teal-700 dark:text-teal-300': activeTab === <?php echo e($log->id); ?> }">
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pembimbing\logbook.blade.php ENDPATH**/ ?>