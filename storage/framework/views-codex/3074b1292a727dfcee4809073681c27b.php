     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Penilaian Akhir Magang')); ?>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-gray-800 dark:text-gray-100"><?php echo e($app->user->name); ?></h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400 font-medium flex items-center gap-2 mt-0.5">
                            <span><i class="far fa-envelope mr-1"></i> <?php echo e($app->user->email); ?></span>
                            <span>•</span>
                            <span class="text-teal-600 dark:text-teal-400 font-bold"><i class="fas fa-briefcase mr-1"></i> <?php echo e($app->position->judul_posisi); ?></span>
                        </p>
                    </div>
                </div>

                <div class="p-6 sm:p-8" x-data="{ 
                    disiplin: <?php echo e(old('nilai_disiplin', $app->nilai_disiplin ?? 0)); ?>,
                    kinerja: <?php echo e(old('nilai_kinerja', $app->nilai_kinerja ?? 0)); ?>,
                    get total() {
                    ...
                    <form action="<?php echo e(route('pembimbing_lapangan.grading.store', $app->id)); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="catatan_pembimbing_lapangan" rows="4" 
                                ...
                                placeholder="Tuliskan catatan evaluasi, apresiasi, atau masukan untuk peserta magang..."><?php echo e(old('catatan_pembimbing_lapangan', $app->catatan_pembimbing_lapangan)); ?></textarea>
                        </div>
                        ...
                        <div class="pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col-reverse sm:flex-row items-center justify-end gap-3">
                            <a href="<?php echo e(route('pembimbing_lapangan.dashboard')); ?>" class="w-full sm:w-auto text-center px-6 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-400 font-bold hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-100 transition text-xs">
                                Batal
                            </a>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pembimbing_lapangan\grading.blade.php ENDPATH**/ ?>