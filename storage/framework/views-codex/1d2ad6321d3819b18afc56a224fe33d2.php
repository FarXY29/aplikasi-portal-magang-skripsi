...
<body>
        ...
        <table style="width: 100%; border: none; margin: 0;">
            <tr style="border: none;">
                ...
                <td style="border: none; width: 50%; font-size: 8px; color: #555; text-align: right; vertical-align: top; padding: 0;">
                    <strong>Pencarian Instansi:</strong> <?php echo e($request->q ?: 'Semua'); ?> &nbsp;|&nbsp;
                    <strong>Filter Kategori:</strong> <?php echo e($request->disiplin_range ? strtoupper($request->disiplin_range) : 'Semua'); ?>
    ...
    <table class="stats-table">
        <tr>
            <td style="width: 16.66%">
                ...
                <div class="value"><?php echo e($stats['total_instansi']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Rerata Disiplin</div>
                <div class="value" style="color: #0d9488;"><?php echo e($stats['avg_disiplin']); ?>%</div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Total Absensi</div>
                <div class="value" style="color: #2563eb;"><?php echo e($stats['total_kehadiran']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Total Pelanggaran</div>
                <div class="value" style="color: #dc2626;"><?php echo e($stats['total_pelanggaran']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Total Terlambat</div>
                <div class="value" style="color: #d97706;"><?php echo e($stats['total_terlambat']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Total Alpa</div>
                <div class="value" style="color: #7c3aed;"><?php echo e($stats['total_alpa']); ?></div>
            </td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="text-center text-bold"><?php echo e($index + 1); ?></td>
                    <td>
                        <strong><?php echo e($data->nama_dinas); ?></strong><br>
                        <span style="font-size: 7px; color: #555;">Jam Masuk Dinas: <?php echo e($data->jam_mulai_masuk ?: '08:00:00'); ?></span>
                    </td>
                    <td class="text-center"><?php echo e($data->total_attendances); ?> Kehadiran</td>
                    <td class="text-center" style="color: #d97706; font-weight: bold;"><?php echo e($data->total_terlambat); ?>x</td>
                    <td class="text-center" style="color: #dc2626; font-weight: bold;"><?php echo e($data->total_alpa); ?>x</td>
                    <td class="text-center text-bold">
                        ...
                        ?>
                        <span class="<?php echo e($disClass); ?>"><?php echo e(number_format($data->tingkat_disiplin, 1)); ?>%</span>
                    </td>
                </tr>
    ...
    <div class="footer">
        <p>Laporan Kedisiplinan Instansi ini merupakan hasil rekapitulasi data program magang Kota Banjarmasin. &copy; <?php echo e(date('Y')); ?></p>
    </div>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\admin_kota\instansi_disiplin.blade.php ENDPATH**/ ?>