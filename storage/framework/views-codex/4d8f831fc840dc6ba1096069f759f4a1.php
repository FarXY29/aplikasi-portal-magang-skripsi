...
?>
<span class="px-2.5 py-1 inline-flex text-xs leading-5 font-bold rounded-full border <?php echo e($colors[$role] ?? 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-700'); ?>">
    <?php echo e($roleName); ?>

</span><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\users\partials\role-badge.blade.php ENDPATH**/ ?>