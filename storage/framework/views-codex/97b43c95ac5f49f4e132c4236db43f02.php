<div class="space-y-1.5">
        ...
        <a href="<?php echo e(route('pembimbing_lapangan.attendance.index')); ?>" 
           ...
           <i class="fas fa-clipboard-list w-5 mr-3.5 text-center transition-transform group-hover:scale-110 <?php echo e(request()->routeIs('pembimbing_lapangan.attendance.*') ? 'text-white' : 'text-gray-400 group-hover:text-teal-600'); ?>"></i>
           <span>Absensi Peserta</span>
        </a>
    </div><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\layouts\partials\nav\_pembimbing_lapangan.blade.php ENDPATH**/ ?>