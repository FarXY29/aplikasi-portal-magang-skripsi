     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Dashboard Pembimbing Akademik')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 sm:p-8">
                    <h3 class="text-2xl font-black text-gray-900 dark:text-gray-100 mb-2">Selamat datang, <?php echo e(Auth::user()->name); ?>!</h3>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-6 font-medium leading-relaxed">
                        ...
                        <?php if(Auth::user()->asal_instansi): ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <form action="<?php echo e(route('pembimbing.dashboard')); ?>" method="GET" class="w-full md:w-auto flex items-center gap-2">
                        <div class="bg-gray-100 dark:bg-gray-900 p-1 rounded-xl flex items-center w-full justify-between md:w-auto border border-gray-200 dark:border-gray-700">
                            <label class="cursor-pointer flex-1 md:flex-initial text-center">
                                <input type="radio" name="status" value="aktif" <?php echo e($statusFilter === 'aktif' ? 'checked' : ''); ?> class="sr-only peer" onchange="this.form.submit()">
                            ...
                            <label class="cursor-pointer flex-1 md:flex-initial text-center">
                                <input type="radio" name="status" value="selesai" <?php echo e($statusFilter === 'selesai' ? 'checked' : ''); ?> class="sr-only peer" onchange="this.form.submit()">
                                <span class="px-3.5 py-1.5 text-xs font-bold rounded-lg text-gray-500 dark:text-gray-400 peer-checked:bg-white dark:peer-checked:bg-gray-800 peer-checked:text-teal-600 dark:peer-checked:text-teal-400 peer-checked:shadow-xs transition block">
                                    Selesai
                                </span>
                            </label>
                            <label class="cursor-pointer flex-1 md:flex-initial text-center">
                                <input type="radio" name="status" value="semua" <?php echo e($statusFilter === 'semua' ? 'checked' : ''); ?> class="sr-only peer" onchange="this.form.submit()">
                                <span class="px-3.5 py-1.5 text-xs font-bold rounded-lg text-gray-500 dark:text-gray-400 peer-checked:bg-white dark:peer-checked:bg-gray-800 peer-checked:text-teal-600 dark:peer-checked:text-teal-400 peer-checked:shadow-xs transition block">
                                    Semua
                                </span>
                            </label>
                ...
                <div>
                    <?php if($applications->isEmpty()): ?>
                        <div class="p-12 text-center text-gray-400 dark:text-gray-500">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Tidak ada mahasiswa magang dengan status "<?php echo e(ucfirst($statusFilter)); ?>".</p>
                        </div>
                    <?php else: ?>
                                        ...
                                        <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20 transition duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100"><?php echo e($app->user->name); ?></div>
                                                        <div class="text-xs text-gray-500 dark:text-gray-400 font-medium"><?php echo e($app->user->major ?? '-'); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="text-sm font-bold text-gray-900 dark:text-gray-100"><?php echo e($app->position->instansi->nama_dinas); ?></div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400 font-medium"><?php echo e($app->position->posisi); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                ?>
                                                <span class="inline-flex mt-1.5 items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold border <?php echo e($statusVal == 'selesai' ? 'bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800/60' : 'bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/60'); ?>">
                                                    <?php echo e($statusLabel); ?>

                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-center space-x-2">
                                                <a href="<?php echo e(route('pembimbing.peserta.logbook', $app->id)); ?>" class="inline-flex items-center px-3.5 py-1.5 bg-white dark:bg-gray-800 border border-teal-300 dark:border-teal-700/80 text-teal-700 dark:text-teal-300 rounded-xl hover:bg-teal-50 dark:hover:bg-teal-950/60 transition text-xs font-bold shadow-xs">
                                                    <i class="fas fa-book-open mr-1.5 text-teal-600 dark:text-teal-400"></i> Logbook
                                                </a>
                                                <a href="<?php echo e(route('pembimbing.peserta.absensi', $app->id)); ?>" class="inline-flex items-center px-3.5 py-1.5 bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-700/80 text-blue-700 dark:text-blue-300 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-950/60 transition text-xs font-bold shadow-xs">
                            ...
                            <div class="p-5 space-y-3 hover:bg-teal-50/10 dark:hover:bg-teal-950/20 transition">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <?php
                                        ...
                                        $statusVal = $app->status instanceof \UnitEnum ? $app->status->value : $app->status;
                                    ?>
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold border <?php echo e($statusVal == 'selesai' ? 'bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800/60' : 'bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800/60'); ?>">
                                        <?php echo e($statusLabel); ?>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900 p-3.5 rounded-2xl border border-gray-200 dark:border-gray-700 space-y-1.5 text-xs">
                                    <div class="flex items-center gap-2 text-gray-800 dark:text-gray-200 font-bold">
                                        ...
                                        <span><?php echo e($app->position->instansi->nama_dinas); ?></span>
                                    </div>
                                    <div class="flex items-center gap-2 text-gray-600 dark:text-gray-400 font-medium">
                                        ...
                                        <span><?php echo e($app->position->posisi); ?></span>
                                    </div>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pembimbing\dashboard.blade.php ENDPATH**/ ?>