    ...
    <table class="stats-table">
        <tr>
            <td style="width: 16.66%">
                ...
                <div class="value"><?php echo e($stats['total_peserta']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Peserta Aktif</div>
                <div class="value text-green"><?php echo e($stats['aktif']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Alumni Lulus</div>
                <div class="value text-blue"><?php echo e($stats['selesai']); ?></div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Avg Kehadiran</div>
                <div class="value text-green"><?php echo e($stats['avg_kehadiran']); ?>%</div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Avg Logbook</div>
                <div class="value text-blue"><?php echo e($stats['avg_logbook']); ?>%</div>
            </td>
            <td style="width: 16.66%">
                <div class="label">Avg Nilai Lulus</div>
                <div class="value text-orange"><?php echo e($stats['avg_nilai'] > 0 ? $stats['avg_nilai'] : '-'); ?></div>
            </td>
        </tr>
    </table>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $kinerja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr class="peserta-row" style="background-color: #f3f4f6;">
                    ...
                    <td>
                        ...
                        <small style="font-weight: normal; color: #555;"><?php echo e($app->user->asal_instansi ?? '-'); ?></small>
                    </td>
                    <td><?php echo e($app->position->judul_posisi); ?></td>
                    <td class="text-center"><?php echo e(round($app->attendance_rate, 1)); ?>%</td>
                    <td class="text-center"><?php echo e(round($app->log_rate, 1)); ?>%</td>
                    <td class="text-center">
                        <?php echo e($app->status?->value == 'diterima' ? 'Aktif' : 'Selesai'); ?>

                    </td>
                    <td class="text-center font-bold">
                        <?php echo e($app->avg_nilai > 0 ? round($app->avg_nilai, 1) : '-'); ?>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div style="width: 30%; float: left; margin-right: 4%;">
                                ...
                                <table class="detail-table">
                                    <tr>
                                        <td>Hadir:</td>
                                        <td class="text-bold text-center"><?php echo e($app->attendances->where('status', 'hadir')->count()); ?> hari</td>
                                    </tr>
                                    <tr>
                                        <td>Sakit:</td>
                                        <td class="text-bold text-center"><?php echo e($app->attendances->where('status', 'sakit')->count()); ?> hari</td>
                                    </tr>
                                    <tr>
                                        <td>Izin:</td>
                                        <td class="text-bold text-center"><?php echo e($app->attendances->where('status', 'izin')->count()); ?> hari</td>
                                    </tr>
                                    <tr>
                                        <td>Alfa:</td>
                                        <td class="text-bold text-center"><?php echo e($app->attendances->where('status', 'alfa')->count()); ?> hari</td>
                                    </tr>
                                    <tr>
                                        <td>Pending:</td>
                                        <td class="text-bold text-center" style="<?php echo e($app->attendances->where('validation_status', 'pending')->count() > 0 ? 'color: red;' : ''); ?>">
                                            <?php echo e($app->attendances->where('validation_status', 'pending')->count()); ?> hari
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="width: 30%; float: left; margin-right: 4%;">
                                ...
                                <table class="detail-table">
                                    <tr>
                                        <td>Total Jurnal:</td>
                                        <td class="text-bold text-center"><?php echo e($app->logs->count()); ?> entri</td>
                                    </tr>
                                    <tr>
                                        <td>Disetujui:</td>
                                        <td class="text-bold text-center text-green"><?php echo e($app->logs->where('status_validasi', 'disetujui')->count()); ?> entri</td>
                                    </tr>
                                    <tr>
                                        <td>Pending:</td>
                                        <td class="text-bold text-center" style="<?php echo e($app->logs->where('status_validasi', 'pending')->count() > 0 ? 'color: red;' : ''); ?>">
                                            <?php echo e($app->logs->where('status_validasi', 'pending')->count()); ?> entri
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Revisi:</td>
                                        <td class="text-bold text-center" style="<?php echo e($app->logs->where('status_validasi', 'revisi')->count() > 0 ? 'color: orange;' : ''); ?>">
                                            <?php echo e($app->logs->where('status_validasi', 'revisi')->count()); ?> entri
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                ...
                                <?php if($app->status?->value === 'selesai'): ?>
                                    <div style="font-size: 7px; background-color: #f9fafb; padding: 4px; border: 1px solid #e5e7eb; border-radius: 3px; line-height: 1.2;">
                                        <div style="margin-bottom: 2px;">
                                            Kerajinan: <strong><?php echo e($app->nilai_kerajinan ?? '-'); ?></strong> &nbsp;|&nbsp; 
                                            Disiplin: <strong><?php echo e($app->nilai_disiplin ?? '-'); ?></strong> &nbsp;|&nbsp; 
                                            Adaptasi: <strong><?php echo e($app->nilai_adaptasi ?? '-'); ?></strong>
                                        </div>
                                        <div style="margin-bottom: 3px;">
                                            Kreatifitas: <strong><?php echo e($app->nilai_kreatifitas ?? '-'); ?></strong> &nbsp;|&nbsp; 
                                            Skill: <strong><?php echo e($app->nilai_skill_pengetahuan ?? '-'); ?></strong>
                                        </div>
                                        <div style="border-top: 1px solid #ddd; padding-top: 3px; font-size: 8px;">
                                            Rerata: <strong><?php echo e(round($app->avg_nilai, 1)); ?> (<?php echo e($app->predikat ?? '-'); ?>)</strong><br>
                                            <?php if($app->nomor_sertifikat): ?>
                                                Sertifikat: <span style="font-family: monospace; font-weight: bold; background: #fff; border: 1px solid #ccc; padding: 0px 2px;"><?php echo e($app->nomor_sertifikat); ?></span><br>
                                            <?php endif; ?>
                                            Pembimbing: <strong><?php echo e($app->pembimbing_lapangan->name ?? '-'); ?></strong>
                                        </div>
                                        <?php if($app->catatan_pembimbing_lapangan): ?>
                                            <div style="margin-top: 3px; border-top: 1px dashed #ccc; padding-top: 2px; font-size: 7px; color: #555; font-style: italic;">
                                                Catatan: "<?php echo e($app->catatan_pembimbing_lapangan); ?>"
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\admin_instansi\kinerja_peserta.blade.php ENDPATH**/ ?>