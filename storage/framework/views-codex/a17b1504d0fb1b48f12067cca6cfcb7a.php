     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-teal-700 to-emerald-600 dark:from-teal-400 dark:to-emerald-300 leading-tight flex items-center gap-3 drop-shadow-sm">
                ...
                <?php echo e(__('Buat Lowongan Baru')); ?>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="bg-white dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-100/60 dark:border-gray-700/60 overflow-hidden transform transition-all">
                ...
                <div class="p-8 md:p-10">
                    <form action="<?php echo e(route('dinas.lowongan.store')); ?>" method="POST" id="lowongan-form">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <div class="relative transition-all duration-300 group-focus-within:drop-shadow-sm">
                                            <input type="text" name="judul_posisi" id="judul_posisi" value="<?php echo e(old('judul_posisi')); ?>" 
...
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-bold text-slate-800 dark:text-gray-100 text-lg placeholder-slate-400 dark:placeholder-gray-500"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="relative transition-all duration-300 group-focus-within:drop-shadow-sm">
                                                <input type="text" name="required_major" id="required_major" value="<?php echo e(old('required_major')); ?>" 
...
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-medium text-slate-800 dark:text-gray-100 placeholder-slate-400 dark:placeholder-gray-500"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="relative group">
                                            ...
                                            <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                                <input type="number" name="kuota" id="kuota" value="<?php echo e(old('kuota', 1)); ?>" min="1" 
                                                    class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['kuota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 transition-all font-medium text-slate-800 dark:text-gray-100" required
                                                    oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                                    oninput="this.setCustomValidity('')">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md md:w-1/2">
                                            <input type="date" name="batas_daftar" id="batas_daftar" value="<?php echo e(old('batas_daftar')); ?>" 
                                                class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['batas_daftar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 transition-all font-medium text-slate-800 dark:text-gray-100 [color-scheme:light] dark:[color-scheme:dark]"
...
unset($__errorArgs, $__bag); ?> shadow-sm focus-within:ring-4 transition-all duration-300 bg-white dark:bg-gray-800">
                                            <textarea id="editor" name="deskripsi" class="w-full border-0 focus:ring-0 bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100"><?php echo e(old('deskripsi')); ?></textarea>
                                        </div>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_instansi\lowongan\create.blade.php ENDPATH**/ ?>