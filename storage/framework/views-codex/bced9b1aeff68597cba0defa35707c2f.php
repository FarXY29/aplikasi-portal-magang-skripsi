...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            <?php $__currentLoopData = $penyerapan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="text-align: center;"><?php echo e($index + 1); ?></td>
                <td><?php echo e($data->nama_dinas); ?></td>
                <td style="text-align: center;"><?php echo e($data->total_kuota); ?></td>
                <td style="text-align: center;"><?php echo e($data->total_terserap); ?></td>
                <td style="text-align: center;"><?php echo e(number_format($data->persentase_penyerapan, 1)); ?>%</td>
            </tr>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\admin_kota\penyerapan_kuota.blade.php ENDPATH**/ ?>