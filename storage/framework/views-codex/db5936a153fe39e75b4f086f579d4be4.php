     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Analisis Kompetensi & Performa')); ?>
            ...
            <div class="text-xs font-bold text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 px-4 py-2 rounded-2xl shadow-xs border border-gray-200 dark:border-gray-700">
                Total Terfilter: <span class="font-black text-teal-600 dark:text-teal-400 font-mono"><?php echo e($stats['total']); ?></span> Peserta
            </div>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total seluruh peserta magang se-Kota Banjarmasin yang telah memiliki penilaian evaluasi akhir.">
                    ...
                    <p class="text-2xl font-black text-gray-800 dark:text-gray-100 font-mono tracking-tight"><?php echo e(number_format($stats['total'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah peserta dengan predikat 'Sangat Baik'. Kriteria Nilai Rata-Rata: 86,00 s.d. 100,00.">
                    ...
                    <p class="text-2xl font-black text-emerald-600 dark:text-emerald-400 font-mono tracking-tight"><?php echo e(number_format($stats['sangat_baik'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah peserta dengan predikat 'Baik'. Kriteria Nilai Rata-Rata: 71,00 s.d. 85,99.">
                    ...
                    <p class="text-2xl font-black text-blue-600 dark:text-blue-400 font-mono tracking-tight"><?php echo e(number_format($stats['baik'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah peserta dengan predikat 'Cukup'. Kriteria Nilai Rata-Rata: 56,00 s.d. 70,99.">
                    ...
                    <p class="text-2xl font-black text-amber-600 dark:text-amber-400 font-mono tracking-tight"><?php echo e(number_format($stats['cukup'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah peserta dengan predikat 'Kurang'. Kriteria Nilai Rata-Rata: 0,00 s.d. 55,99.">
                    ...
                    <p class="text-2xl font-black text-rose-600 dark:text-rose-400 font-mono tracking-tight"><?php echo e(number_format($stats['kurang'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help bg-gradient-to-br from-teal-50/50 via-white to-indigo-50/30 dark:from-teal-950/20 dark:via-gray-800 dark:to-indigo-950/20" title="Nilai rata-rata evaluasi akhir akumulasi seluruh peserta yang telah dinilai di Kota Banjarmasin. Rumus: (Total Nilai Rata-Rata Seluruh Peserta / Jumlah Peserta Dinilai).">
                    ...
                    <p class="text-2xl font-black text-teal-600 dark:text-teal-400 font-mono tracking-tight"><?php echo e($stats['avg_nilai']); ?></p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-xs border border-gray-100 dark:border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-6 cursor-help" title="Perbandingan nilai rata-rata 3 aspek utama: Teknis, Disiplin, dan Perilaku peserta se-Kota Banjarmasin.">
                <div class="cursor-help" title="Rata-rata aspek keahlian teknis peserta. Rumus: (Total Nilai Teknis / Jumlah Peserta Dinilai). Nilai Teknis = Skill Pengetahuan.">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm font-black text-gray-800 dark:text-gray-200 font-mono"><?php echo e($statsGlobal['avg_teknis']); ?>/100</span>
                    </div>
                    <div class="w-full bg-gray-100 dark:bg-gray-900 h-2 rounded-full overflow-hidden border border-transparent dark:border-gray-700">
                        <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e($statsGlobal['avg_teknis']); ?>%"></div>
                    </div>
                </div>
                <div class="cursor-help" title="Rata-rata aspek kedisiplinan dan ketepatan waktu peserta. Rumus: (Total Nilai Disiplin / Jumlah Peserta Dinilai).">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm font-black text-gray-800 dark:text-gray-200 font-mono"><?php echo e($statsGlobal['avg_disiplin']); ?>/100</span>
                    </div>
                    <div class="w-full bg-gray-100 dark:bg-gray-900 h-2 rounded-full overflow-hidden border border-transparent dark:border-gray-700">
                        <div class="bg-emerald-500 h-2 rounded-full" style="width: <?php echo e($statsGlobal['avg_disiplin']); ?>%"></div>
                    </div>
                </div>
                <div class="cursor-help" title="Rata-rata aspek etika, keaktifan, dan komunikasi peserta. Rumus: (Total Nilai Perilaku / Jumlah Peserta). Nilai Perilaku = (Adaptasi + Kreativitas + Kerajinan) / 3.">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm font-black text-gray-800 dark:text-gray-200 font-mono"><?php echo e($statsGlobal['avg_perilaku']); ?>/100</span>
                    </div>
                    <div class="w-full bg-gray-100 dark:bg-gray-900 h-2 rounded-full overflow-hidden border border-transparent dark:border-gray-700">
                        <div class="bg-purple-500 h-2 rounded-full" style="width: <?php echo e($statsGlobal['avg_perilaku']); ?>%"></div>
                    </div>
                </div>
            </div>

            
            <?php if($podium->count() > 0): ?>
                        ...
                        <div class="w-full md:w-1/3 order-2 md:order-1 flex flex-col items-center">
                            <div class="relative mb-3 flex flex-col items-center">
                                <div class="h-16 w-16 rounded-full bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center text-gray-700 dark:text-gray-100 font-black border-4 border-white dark:border-gray-700 shadow-md text-lg relative">
                                    <?php echo e(strtoupper(substr($p2['nama'], 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-bold text-gray-800 dark:text-gray-200 text-sm truncate max-w-[180px]"><?php echo e($p2['nama']); ?></p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400 truncate max-w-[180px] font-semibold"><?php echo e($p2['asal_instansi']); ?></p>
                                <p class="text-[9px] text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/50 border border-teal-100 dark:border-teal-900/40 px-2 py-0.5 rounded-full inline-block font-bold mt-1"><?php echo e($p2['instansi']); ?></p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-gray-100 to-gray-200/50 dark:from-gray-900 dark:to-gray-800/80 rounded-t-2xl pt-8 pb-4 text-center border-t border-gray-200 dark:border-gray-700 shadow-xs flex flex-col justify-center items-center h-28">
                                ...
                                <span class="text-2xl font-black text-gray-700 dark:text-gray-200 font-mono mt-1"><?php echo e($p2['rata_rata']); ?></span>
                                <span class="text-[9px] font-extrabold text-gray-500 dark:text-gray-400 mt-1 uppercase"><?php echo e($p2['predikat']); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="w-full md:w-1/3 order-1 md:order-2 flex flex-col items-center transform md:-translate-y-4">
                            <div class="relative mb-3 flex flex-col items-center">
                                ...
                                <div class="h-20 w-20 rounded-full bg-gradient-to-br from-amber-300 to-amber-500 flex items-center justify-center text-white font-black border-4 border-white dark:border-gray-700 shadow-lg text-xl relative">
                                    <?php echo e(strtoupper(substr($p1['nama'], 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-black text-gray-900 dark:text-gray-100 text-base truncate max-w-[200px]"><?php echo e($p1['nama']); ?></p>
                                <p class="text-xs text-gray-700 dark:text-gray-300 truncate max-w-[200px] font-bold"><?php echo e($p1['asal_instansi']); ?></p>
                                <p class="text-[10px] text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/50 border border-teal-200 dark:border-teal-900/40 px-2.5 py-0.5 rounded-full inline-block font-extrabold mt-1"><?php echo e($p1['instansi']); ?></p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-amber-50 to-amber-100 dark:from-amber-950/40 dark:to-amber-900/20 rounded-t-2xl pt-10 pb-6 text-center border-t-2 border-amber-300 dark:border-amber-700 shadow flex flex-col justify-center items-center h-36">
                                ...
                                <span class="text-3xl font-black text-amber-700 dark:text-amber-400 font-mono mt-1"><?php echo e($p1['rata_rata']); ?></span>
                                <span class="text-[10px] font-black text-amber-600 dark:text-amber-300 mt-1 uppercase"><?php echo e($p1['predikat']); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>

                        
                        <?php if($podium->count() > 2): ?>
                        <?php $p3 = $podium[2]; ?>
                        <div class="w-full md:w-1/3 order-3 md:order-3 flex flex-col items-center">
                            <div class="relative mb-3 flex flex-col items-center">
                                <div class="h-16 w-16 rounded-full bg-gradient-to-br from-amber-600 to-amber-800/80 flex items-center justify-center text-white font-black border-4 border-white dark:border-gray-700 shadow-md text-lg relative">
                                    <?php echo e(strtoupper(substr($p3['nama'], 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-bold text-gray-800 dark:text-gray-200 text-sm truncate max-w-[180px]"><?php echo e($p3['nama']); ?></p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400 truncate max-w-[180px] font-semibold"><?php echo e($p3['asal_instansi']); ?></p>
                                <p class="text-[9px] text-teal-600 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/50 border border-teal-100 dark:border-teal-900/40 px-2 py-0.5 rounded-full inline-block font-bold mt-1"><?php echo e($p3['instansi']); ?></p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-orange-50/50 to-orange-100/30 dark:from-orange-950/40 dark:to-orange-900/20 rounded-t-2xl pt-8 pb-4 text-center border-t border-orange-200 dark:border-orange-900/40 shadow-xs flex flex-col justify-center items-center h-24">
                                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">SKOR AKHIR</span>
                                <span class="text-xl font-black text-amber-700 dark:text-amber-400 font-mono mt-1"><?php echo e($p3['rata_rata']); ?></span>
                                <span class="text-[9px] font-extrabold text-orange-700 dark:text-orange-400 mt-1 uppercase"><?php echo e($p3['predikat']); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
            ...
            <div class="w-full space-y-6" x-data="{ openRow: null }">
                <div class="bg-white dark:bg-gray-800 shadow-xs sm:rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-gray-50/50 dark:bg-gray-900/50">
                        ...
                        <form method="GET" action="<?php echo e(route('admin.laporan.grading')); ?>" class="flex flex-wrap sm:flex-nowrap lg:flex-row gap-2.5 items-center w-full xl:w-auto">
                            <!-- Search Name -->
                            <div class="relative w-full sm:w-44">
                                ...
                                <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari nama..."
                            ...
                            <div class="w-full sm:w-40">
                                <select name="instansi" class="w-full py-2 px-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500 shadow-xs cursor-pointer [color-scheme:dark]">
                                    ...
                                    <?php $__currentLoopData = $listCampus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($campus); ?>" <?php echo e(request('instansi') == $campus ? 'selected' : ''); ?>>
                                            <?php echo e(Str::limit($campus, 25)); ?>
                                ...
                                <select name="instansi_id" class="w-full py-2 px-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500 shadow-xs cursor-pointer [color-scheme:dark]">
                                    ...
                                    <?php $__currentLoopData = $listDinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dinas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dinas->id); ?>" <?php echo e(request('instansi_id') == $dinas->id ? 'selected' : ''); ?>>
                                            <?php echo e(Str::limit($dinas->nama_dinas, 25)); ?>
                            ...
                            <div class="w-full sm:w-36">
                                <select name="predikat" class="w-full py-2 px-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500 shadow-xs cursor-pointer [color-scheme:dark]">
                                    ...
                                    <option value="Sangat Baik" <?php echo e(request('predikat') == 'Sangat Baik' ? 'selected' : ''); ?>>Sangat Baik</option>
                                    <option value="Baik" <?php echo e(request('predikat') == 'Baik' ? 'selected' : ''); ?>>Baik</option>
                                    <option value="Cukup" <?php echo e(request('predikat') == 'Cukup' ? 'selected' : ''); ?>>Cukup</option>
                                    <option value="Kurang" <?php echo e(request('predikat') == 'Kurang' ? 'selected' : ''); ?>>Kurang</option>
                                </select>
                            </div>
                            ...
                            <div class="flex gap-2 w-full sm:w-auto">
                                ...
                                <?php if(request()->anyFilled(['q', 'instansi', 'instansi_id', 'predikat'])): ?>
                                    <a href="<?php echo e(route('admin.laporan.grading')); ?>" class="px-3 py-2 border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl font-bold text-xs shadow-xs transition flex items-center justify-center">
                                        Reset
                                    </a>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="hidden md:block overflow-x-auto max-h-[650px] overflow-y-auto">
                        <table class="w-full divide-y divide-gray-100 dark:divide-gray-700 border-collapse">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700/60 text-sm">
                                <?php $__empty_1 = true; $__currentLoopData = $gradedList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20 transition group cursor-pointer" @click="openRow = (openRow === <?php echo e($index); ?> ? null : <?php echo e($index); ?>)">
                                    <td class="px-4 py-4 text-center">
                                        <?php if($index == 0 && !request('q') && !request('instansi') && !request('instansi_id') && !request('predikat')): ?>
                                        ...
                                        <?php elseif($index == 1 && !request('q') && !request('instansi') && !request('instansi_id') && !request('predikat')): ?>
                                        ...
                                        <?php elseif($index == 2 && !request('q') && !request('instansi') && !request('instansi_id') && !request('predikat')): ?>
                                    ...
                                    <td class="px-6 py-4 min-w-[200px] max-w-[260px]">
                                        <div class="flex items-center gap-3">
                                            <div class="h-9 w-9 rounded-full bg-teal-50 dark:bg-teal-950/60 text-teal-700 dark:text-teal-300 font-black border border-teal-200 dark:border-teal-800/60 text-xs flex-shrink-0 flex items-center justify-center">
                                                <?php echo e(strtoupper(substr($res['nama'], 0, 2))); ?>

                                            </div>
                                            <div class="min-w-0 flex-1">
                                                <div class="font-bold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2" title="<?php echo e($res['nama']); ?>"><?php echo e($res['nama']); ?></div>
                                                <div class="text-[11px] text-gray-500 dark:text-gray-400 font-semibold leading-snug line-clamp-2 mt-0.5" title="<?php echo e($res['asal_instansi']); ?>">
                                                    <i class="fas fa-university mr-1 text-gray-400 dark:text-gray-500"></i> <?php echo e($res['asal_instansi']); ?>
                                    ...
                                    <td class="px-6 py-4 min-w-[220px] max-w-[280px]">
                                        <div class="flex flex-col gap-0.5">
                                            <span class="font-bold text-gray-900 dark:text-gray-100 text-xs leading-snug line-clamp-2" title="<?php echo e($res['instansi']); ?>">
                                                <i class="far fa-building text-gray-400 dark:text-gray-500 mr-1"></i>
                                                <?php echo e($res['instansi']); ?>

                                            </span>
                                            <span class="text-[11px] text-teal-600 dark:text-teal-400 font-medium leading-snug line-clamp-2 mt-0.5" title="<?php echo e($res['posisi']); ?>">
                                                Posisi: <?php echo e($res['posisi']); ?>

                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        <span class="text-sm font-black text-teal-700 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/60 border border-teal-200 dark:border-teal-800/60 px-2.5 py-1 rounded-full inline-block font-mono"><?php echo e($res['rata_rata']); ?></span>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        <?php
                                        ...
                                        ?>
                                        <span class="px-2.5 py-1 text-[10px] font-black uppercase rounded-full border <?php echo e($badgeColor); ?>">
                                            <?php echo e($res['predikat']); ?>
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <div class="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-900 flex items-center justify-center mx-auto border border-gray-200 dark:border-gray-700">
                                            <i class="fas fa-chevron-down text-gray-400 dark:text-gray-500 text-xs transition-transform duration-200" :class="openRow === <?php echo e($index); ?> ? 'rotate-180 text-teal-600 dark:text-teal-400' : ''"></i>
                                        </div>
                                    </td>
                                </tr>

                                
                                <tr x-show="openRow === <?php echo e($index); ?>" x-transition.opacity x-cloak>
                                    <td colspan="6" class="px-4 py-4 bg-gray-50/80 dark:bg-gray-900/60 border-y border-gray-100 dark:border-gray-700">
                                        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 shadow-xs space-y-4">
                                            ...
                                            <?php if($res['nilai_rata_rata'] !== null): ?>
                                                ...
                                                <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['kerajinan']); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kedisiplinan</div>
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['disiplin']); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Adaptasi</div>
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['adaptasi']); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kreatifitas</div>
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['kreatifitas']); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700 col-span-2 md:col-span-1">
                                                        ...
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['skill']); ?></div>
                                                    </div>
                                                </div>
                                                <div class="mt-3 flex items-center justify-between text-xs text-gray-400 dark:text-gray-500 italic">
                                                    ...
                                                    <span>Rata-rata: <strong class="text-gray-800 dark:text-gray-200 font-mono"><?php echo e($res['rata_rata']); ?></strong></span>
                                                </div>
                                            <?php else: ?>
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['teknis']); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kedisiplinan</div>
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['disiplin']); ?></div>
                                                    ...
                                                    <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        <div class="text-xl font-black text-gray-800 dark:text-gray-200 font-mono mt-1"><?php echo e($res['perilaku']); ?></div>
                                                    </div>
                                                </div>
                                                <div class="mt-3 flex items-center justify-between text-xs text-gray-400 dark:text-gray-500 italic">
                        ...
                        <div class="p-4 space-y-3.5 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition" x-data="{ open: false }">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-3 min-w-0">
                                    <div class="flex-shrink-0">
                                        ...
                                        <?php else: ?>
                                            <div class="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-900 text-gray-400 dark:text-gray-500 flex items-center justify-center border border-gray-200 dark:border-gray-700 font-bold text-xs">#<?php echo e($index + 1); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <h4 class="text-sm font-bold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2" title="<?php echo e($res['nama']); ?>"><?php echo e($res['nama']); ?></h4>
                                        <p class="text-[11px] text-gray-500 dark:text-gray-400 font-semibold leading-snug line-clamp-2 mt-0.5" title="<?php echo e($res['asal_instansi']); ?>">
                                            <i class="fas fa-university mr-1 text-gray-400 dark:text-gray-500"></i><?php echo e($res['asal_instansi']); ?>
                                ...
                                <div class="shrink-0">
                                    ...
                                    ?>
                                    <span class="px-2.5 py-1 text-[10px] font-black uppercase rounded-full border <?php echo e($badgeColorMobile); ?>">
                                        <?php echo e($res['predikat']); ?>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-100 dark:border-gray-700 space-y-2.5">
                                <div class="flex items-start gap-2 text-xs">
                                    ...
                                    <span class="font-bold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2" title="<?php echo e($res['instansi']); ?>"><?php echo e($res['instansi']); ?></span>
                                </div>
                                <div class="flex items-start gap-2 text-[11px]">
                                    <i class="fas fa-briefcase text-teal-500 dark:text-teal-400 mt-0.5"></i>
                                    <span class="text-teal-600 dark:text-teal-400 font-medium leading-snug line-clamp-2" title="<?php echo e($res['posisi']); ?>"><?php echo e($res['posisi']); ?></span>
                                </div>
                                ...
                                <?php if($res['nilai_rata_rata'] !== null): ?>
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kerajinan</div>
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['kerajinan']); ?></div>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kedisiplinan</div>
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['disiplin']); ?></div>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Adaptasi</div>
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['adaptasi']); ?></div>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Kreatifitas</div>
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['kreatifitas']); ?></div>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700 col-span-2">
                                            <div class="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase">Skill & Pengetahuan</div>
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['skill']); ?></div>
                                        </div>
                                    </div>
                                ...
                                <?php else: ?>
                                    <div class="grid grid-cols-3 gap-2">
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            ...
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['teknis']); ?></div>
                                        </div>
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-900 p-2.5 rounded-xl border border-gray-200 dark:border-gray-700">
                                            ...
                                            <div class="text-base font-black text-gray-800 dark:text-gray-200 font-mono mt-0.5"><?php echo e($res['perilaku']); ?></div>
                                        </div>
                                    </div>
                                    <div class="flex items-center justify-between text-[10px] text-gray-400 dark:text-gray-500 italic">
                                        <span>*Sistem Penilaian Tambahan (3 Aspek)</span>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/admin_kota/laporan/grading.blade.php ENDPATH**/ ?>