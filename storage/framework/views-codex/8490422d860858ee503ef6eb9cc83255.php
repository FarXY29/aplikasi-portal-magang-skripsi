...
<div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 flex flex-col justify-between stagger-1">
    <div>
        ...
        <div class="text-xl sm:text-2xl md:text-3xl font-black text-gray-900 dark:text-gray-100 mb-1 font-mono animate-count-up">
            <?php echo e($stats['elapsed_days']); ?> <span class="text-xs font-normal text-gray-500 dark:text-gray-400 font-sans">dari <?php echo e($stats['total_days']); ?> Hari</span>
        </div>
    ...
    <div>
        <div class="flex justify-between text-xs font-bold text-gray-700 dark:text-gray-300 mb-2">
            ...
            <span class="text-teal-600 dark:text-teal-400 font-mono font-bold"><?php echo e($stats['progress_percent']); ?>%</span>
        </div>
        <div class="progress-bar-track">
            <div class="progress-bar-fill" style="--progress-width: <?php echo e($stats['progress_percent']); ?>%"></div>
        </div>
    </div>
</div>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/peserta/dashboard/_stats.blade.php ENDPATH**/ ?>