     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Pemantauan Absensi Mahasiswa')); ?>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <a href="<?php echo e(route('pembimbing.dashboard')); ?>" class="group flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition">
            ...
            <div class="bg-white dark:bg-gray-800 p-5 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <form action="<?php echo e(route('pembimbing.peserta.absensi', $app->id)); ?>" method="GET" class="w-full md:w-auto flex flex-wrap items-center gap-4">
                    ...
                    <?php if(request('filter_type') && request('filter_type') != 'semua'): ?>
                        <a href="<?php echo e(route('pembimbing.peserta.absensi', $app->id)); ?>" class="p-2 bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-300 hover:bg-rose-100 border border-rose-200 dark:border-rose-800/60 rounded-xl transition text-xs font-bold flex items-center gap-1.5">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900">
                    ...
                    <span class="bg-teal-50 dark:bg-teal-950/60 text-teal-700 dark:text-teal-300 text-xs font-black px-3 py-1 rounded-full border border-teal-200 dark:border-teal-800/60">
                        Total Hari: <?php echo e($attendances->count()); ?>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full divide-y divide-gray-100 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700/60 text-sm">
                                    <?php $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20 transition duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-bold text-gray-900 dark:text-gray-100">
                                                    <?php echo e(\Carbon\Carbon::parse($absen->date)->translatedFormat('l, d M Y')); ?>
                                            ...
                                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                                <?php if($absen->clock_in): ?>
                                                    <span class="px-3 py-1 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-mono font-bold text-gray-800 dark:text-gray-200">
                                                        <?php echo e(\Carbon\Carbon::parse($absen->clock_in)->format('H:i')); ?>
                                            ...
                                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                                <?php if($absen->clock_out): ?>
                                                    <span class="px-3 py-1 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-mono font-bold text-gray-800 dark:text-gray-200">
                                                        <?php echo e(\Carbon\Carbon::parse($absen->clock_out)->format('H:i')); ?>
                                            ...
                                            <td class="px-6 py-4 text-center whitespace-nowrap">
                                                ...
                                                ?>
                                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full border <?php echo e($statusClass); ?>">
                                                    <?php echo e(ucfirst($absen->status)); ?>

                                                </span>
                                                
                                                <?php if($absen->validation_status == 'valid'): ?>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-xs sm:text-sm text-gray-800 dark:text-gray-200 font-medium leading-relaxed max-w-xs truncate" title="<?php echo e($absen->description); ?>">
                                                    <?php echo e($absen->description ?: '-'); ?>

                                                </div>
                                                <?php if($absen->pembimbing_lapangan_note): ?>
                                                    <div class="mt-1.5 p-2 bg-blue-50/60 dark:bg-blue-950/40 rounded-xl border border-blue-200 dark:border-blue-800/60 text-xs text-blue-900 dark:text-blue-200 italic">
                                                        <strong class="not-italic text-blue-800 dark:text-blue-300">Catatan Lapangan:</strong> <?php echo e($absen->pembimbing_lapangan_note); ?>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pembimbing\absensi.blade.php ENDPATH**/ ?>