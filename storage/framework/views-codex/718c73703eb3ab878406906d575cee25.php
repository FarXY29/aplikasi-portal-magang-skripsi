...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            <?php $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="text-align: center;"><?php echo e($index + 1); ?></td>
                <td><?php echo e($data->nama_dinas); ?></td>
                <td style="text-align: center;"><?php echo e($data->avg_durasi_hari); ?> Hari</td>
                <td style="text-align: center;"><?php echo e($data->avg_durasi_bulan); ?> Bulan</td>
            </tr>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\admin_kota\durasi_magang.blade.php ENDPATH**/ ?>