     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Analisis Kedisiplinan Instansi')); ?>
            ...
            <div class="text-xs font-bold text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 px-4 py-2 rounded-2xl shadow-xs border border-gray-200 dark:border-gray-700">
                Total Terfilter: <span class="font-black text-teal-600 dark:text-teal-400 font-mono"><?php echo e($stats['total_instansi']); ?></span> Instansi
            </div>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total jumlah instansi/dinas Pemerintah Kota Banjarmasin yang masuk dalam evaluasi kedisiplinan presensi.">
                    ...
                    <p class="text-2xl font-black text-gray-800 dark:text-gray-100 font-mono tracking-tight"><?php echo e(number_format($stats['total_instansi'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help bg-gradient-to-br from-teal-50/50 via-white to-indigo-50/30 dark:from-teal-950/20 dark:via-gray-800 dark:to-indigo-950/20" title="Rata-rata persentase kedisiplinan instansi se-Kota Banjarmasin. Rumus Disiplin Instansi: 100% - ((Total Pelanggaran / Total Absensi) x 100%). Pelanggaran = Terlambat + Alpa.">
                    ...
                    <p class="text-2xl font-black text-teal-600 dark:text-teal-400 font-mono tracking-tight"><?php echo e($stats['avg_disiplin']); ?>%</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total seluruh log entri presensi/kehadiran peserta magang pada instansi yang dinilai.">
                    ...
                    <p class="text-2xl font-black text-blue-600 dark:text-blue-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_kehadiran'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total akumulasi kasus pelanggaran presensi peserta magang. Rumus: Total Terlambat + Total Alpa.">
                    ...
                    <p class="text-2xl font-black text-rose-600 dark:text-rose-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_pelanggaran'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total kehadiran peserta yang waktu masuknya melewati jam kerja resmi instansi (clock_in > jam_mulai_masuk dinas).">
                    ...
                    <p class="text-2xl font-black text-orange-600 dark:text-orange-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_terlambat'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total ketidakhadiran peserta tanpa keterangan atau tanpa dokumen izin/sakit yang sah.">
                    ...
                    <p class="text-2xl font-black text-amber-600 dark:text-amber-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_alpa'])); ?></p>
                        ...
                        <div class="w-full md:w-1/3 order-2 md:order-1 flex flex-col items-center">
                            <div class="relative mb-3 flex flex-col items-center">
                                <div class="h-16 w-16 rounded-full bg-gradient-to-br from-gray-100 to-gray-300 dark:from-gray-700 dark:to-gray-600 flex items-center justify-center text-gray-700 dark:text-gray-100 font-black border-4 border-white dark:border-gray-700 shadow-md text-lg relative">
                                    <?php echo e(strtoupper(substr($p2->nama_dinas, 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-bold text-gray-800 dark:text-gray-200 text-sm truncate max-w-[200px]" title="<?php echo e($p2->nama_dinas); ?>"><?php echo e($p2->nama_dinas); ?></p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400 font-semibold"><?php echo e($p2->total_attendances); ?> Kehadiran</p>
                                <p class="text-[9px] text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 px-2 py-0.5 rounded-full inline-block font-bold mt-1 border border-rose-200 dark:border-rose-900/40"><?php echo e($p2->total_pelanggaran); ?> Pelanggaran</p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-gray-100 to-gray-200/50 dark:from-gray-900 dark:to-gray-800/80 rounded-t-2xl pt-8 pb-4 text-center border-t border-gray-200 dark:border-gray-700 shadow-xs flex flex-col justify-center items-center h-28">
                                ...
                                <span class="text-2xl font-black text-gray-800 dark:text-gray-100 font-mono mt-1"><?php echo e(number_format($p2->tingkat_disiplin, 1)); ?>%</span>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="w-full md:w-1/3 order-1 md:order-2 flex flex-col items-center transform md:-translate-y-4">
                            <div class="relative mb-3 flex flex-col items-center">
                                ...
                                <div class="h-20 w-20 rounded-full bg-gradient-to-br from-amber-300 to-amber-500 flex items-center justify-center text-white font-black border-4 border-white dark:border-gray-700 shadow-lg text-xl relative">
                                    <?php echo e(strtoupper(substr($p1->nama_dinas, 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-black text-gray-900 dark:text-gray-100 text-base truncate max-w-[220px]" title="<?php echo e($p1->nama_dinas); ?>"><?php echo e($p1->nama_dinas); ?></p>
                                <p class="text-xs text-gray-700 dark:text-gray-300 font-bold"><?php echo e($p1->total_attendances); ?> Kehadiran</p>
                                <p class="text-[10px] text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 px-2.5 py-0.5 rounded-full inline-block font-extrabold mt-1 border border-rose-200 dark:border-rose-900/50"><?php echo e($p1->total_pelanggaran); ?> Pelanggaran</p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-amber-50 to-amber-100 dark:from-amber-950/40 dark:to-amber-900/20 rounded-t-2xl pt-10 pb-6 text-center border-t-2 border-amber-300 dark:border-amber-700 shadow flex flex-col justify-center items-center h-36">
                                ...
                                <span class="text-3xl font-black text-amber-700 dark:text-amber-400 font-mono mt-1"><?php echo e(number_format($p1->tingkat_disiplin, 1)); ?>%</span>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="w-full md:w-1/3 order-3 md:order-3 flex flex-col items-center">
                            <div class="relative mb-3 flex flex-col items-center">
                                <div class="h-16 w-16 rounded-full bg-gradient-to-br from-amber-600 to-amber-800/80 flex items-center justify-center text-white font-black border-4 border-white dark:border-gray-700 shadow-md text-lg relative">
                                    <?php echo e(strtoupper(substr($p3->nama_dinas, 0, 2))); ?>
                            ...
                            <div class="text-center mb-2">
                                <p class="font-bold text-gray-800 dark:text-gray-200 text-sm truncate max-w-[200px]" title="<?php echo e($p3->nama_dinas); ?>"><?php echo e($p3->nama_dinas); ?></p>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400 font-semibold"><?php echo e($p3->total_attendances); ?> Kehadiran</p>
                                <p class="text-[9px] text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 px-2 py-0.5 rounded-full inline-block font-bold mt-1 border border-rose-200 dark:border-rose-900/40"><?php echo e($p3->total_pelanggaran); ?> Pelanggaran</p>
                            </div>
                            <div class="w-full bg-gradient-to-t from-orange-50/50 to-orange-100/30 dark:from-orange-950/40 dark:to-orange-900/20 rounded-t-2xl pt-8 pb-4 text-center border-t border-orange-200 dark:border-orange-900/40 shadow-xs flex flex-col justify-center items-center h-24">
                                <span class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">KEDISIPLINAN</span>
                                <span class="text-xl font-black text-amber-700 dark:text-amber-400 font-mono mt-1"><?php echo e(number_format($p3->tingkat_disiplin, 1)); ?>%</span>
                            </div>
                        </div>
                        <?php endif; ?>
            ...
            <div class="w-full space-y-6" x-data="{ openRow: null }">
                <div class="bg-white dark:bg-gray-800 shadow-xs sm:rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-gray-50/50 dark:bg-gray-900/50">
                        ...
                        <form method="GET" action="<?php echo e(route('admin.laporan.instansi_disiplin')); ?>" class="flex flex-col sm:flex-row gap-2.5 items-center w-full lg:w-auto">
                            <div class="relative w-full sm:w-56">
                                ...
                                <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari nama dinas..."
                            ...
                            <div class="w-full sm:w-48">
                                <select name="disiplin_range" class="w-full py-2 px-3 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500 shadow-xs cursor-pointer [color-scheme:dark]">
                                    ...
                                    <option value="sangat" <?php echo e(request('disiplin_range') == 'sangat' ? 'selected' : ''); ?>>Sangat Disiplin (>= 90%)</option>
                                    <option value="cukup" <?php echo e(request('disiplin_range') == 'cukup' ? 'selected' : ''); ?>>Cukup Disiplin (70-89%)</option>
                                    <option value="kurang" <?php echo e(request('disiplin_range') == 'kurang' ? 'selected' : ''); ?>>Kurang Disiplin (< 70%)</option>
                                </select>
                            </div>
                            ...
                            <div class="flex gap-2 w-full sm:w-auto">
                                ...
                                <?php if(request()->anyFilled(['q', 'disiplin_range'])): ?>
                                    <a href="<?php echo e(route('admin.laporan.instansi_disiplin')); ?>" class="px-3 py-2 border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl font-bold text-xs shadow-xs transition flex items-center justify-center">
                                        Reset
                                    </a>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="hidden md:block overflow-x-auto max-h-[650px] overflow-y-auto">
                        <table class="w-full divide-y divide-gray-100 dark:divide-gray-700 border-collapse">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700/60 text-sm">
                                <?php $__empty_1 = true; $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20 transition group cursor-pointer" @click="openRow = (openRow === <?php echo e($index); ?> ? null : <?php echo e($index); ?>)">
                                    <td class="px-4 py-4 text-center">
                                        <?php if($index == 0 && !request('q') && !request('disiplin_range') && $res->total_attendances > 0): ?>
                                        ...
                                        <?php elseif($index == 1 && !request('q') && !request('disiplin_range') && $res->total_attendances > 0): ?>
                                        ...
                                        <?php elseif($index == 2 && !request('q') && !request('disiplin_range') && $res->total_attendances > 0): ?>
                                    ...
                                    <td class="px-6 py-4 min-w-[220px] max-w-[320px]">
                                        <div class="flex items-center gap-3">
                                            <div class="h-9 w-9 rounded-full bg-teal-50 dark:bg-teal-950/60 text-teal-700 dark:text-teal-300 font-black border border-teal-200 dark:border-teal-800/60 text-xs flex-shrink-0 flex items-center justify-center">
                                                <?php echo e(strtoupper(substr($res->nama_dinas, 0, 2))); ?>

                                            </div>
                                            <div class="min-w-0 flex-1">
                                                <div class="font-bold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2" title="<?php echo e($res->nama_dinas); ?>"><?php echo e($res->nama_dinas); ?></div>
                                                <div class="text-[11px] text-gray-500 dark:text-gray-400 font-medium flex items-center gap-1 mt-0.5">
                                                    <i class="far fa-clock text-gray-400 dark:text-gray-500"></i> Jam Masuk: <span class="text-gray-700 dark:text-gray-300 font-bold font-mono"><?php echo e($res->jam_mulai_masuk ?: '08:00:00'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        <span class="px-3 py-1 bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-full font-bold text-xs inline-block">
                                            <strong class="font-mono"><?php echo e($res->total_attendances); ?></strong> <span class="text-[10px] text-gray-400 dark:text-gray-500 font-normal">Entri</span>
                                        </span>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        <?php if($res->total_pelanggaran > 0): ?>
                                            <div class="inline-flex items-center gap-1 px-3 py-1 bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800/60 rounded-full">
                                                <span class="text-rose-700 dark:text-rose-300 font-black text-xs font-mono"><?php echo e($res->total_pelanggaran); ?></span>
                                                <span class="text-[10px] text-gray-500 dark:text-gray-400 font-medium">(<?php echo e($res->total_terlambat); ?> Telat, <?php echo e($res->total_alpa); ?> Alpa)</span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex flex-col gap-1 items-center">
                                            ...
                                            <div class="w-20 bg-gray-100 dark:bg-gray-900 h-2 rounded-full overflow-hidden border border-transparent dark:border-gray-700">
                                                <div class="<?php echo e($barColor); ?> h-2 rounded-full" style="width: <?php echo e($res->tingkat_disiplin); ?>%"></div>
                                            </div>
                                            <span class="px-2.5 py-0.5 rounded text-[10px] font-black font-mono <?php echo e($textColor); ?>">
                                                <?php echo e(number_format($res->tingkat_disiplin, 1)); ?>%
                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-center">
                                        ...
                                        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 shadow-xs space-y-4">
                                            <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b pb-2 border-gray-100 dark:border-gray-700 gap-2">
                                                ...
                                                <span class="text-xs text-gray-600 dark:text-gray-400 font-bold uppercase bg-gray-50 dark:bg-gray-900 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700 font-mono">
                                                    Hadir: <?php echo e($res->total_hadir); ?> | Sakit: <?php echo e($res->total_sakit); ?> | Izin: <?php echo e($res->total_izin); ?>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <?php if(count($res->pelanggar_list) > 0): ?>
                                                    <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700">
                                                        <table class="w-full divide-y divide-gray-100 dark:divide-gray-700 text-xs text-left">
                                                            ...
                                                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700/60 bg-white dark:bg-gray-800">
                                                                <?php $__currentLoopData = $res->pelanggar_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20">
                                                                    <td class="px-4 py-3 font-bold text-gray-900 dark:text-gray-100">
                                                                        <?php echo e($p['nama']); ?>

                                                                        <div class="text-[11px] text-gray-500 dark:text-gray-400 font-medium mt-0.5"><?php echo e($p['kampus']); ?></div>
                                                                    </td>
                                                                    <td class="px-4 py-3 text-gray-700 dark:text-gray-300 font-medium"><?php echo e($p['posisi']); ?></td>
                                                                    <td class="px-4 py-3 text-center text-orange-600 dark:text-orange-400 font-bold font-mono"><?php echo e($p['terlambat']); ?>x</td>
                                                                    <td class="px-4 py-3 text-center text-rose-600 dark:text-rose-400 font-bold font-mono"><?php echo e($p['alpa']); ?>x</td>
                                                                    <td class="px-4 py-3 text-center font-black text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-900/50 font-mono">
                                                                        <?php echo e($p['terlambat'] + $p['alpa']); ?>x
                                                                    </td>
                                                                </tr>
                        ...
                        <div class="p-4 space-y-3.5 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <?php else: ?>
                                        <div class="w-8 h-8 rounded-full bg-gray-50 dark:bg-gray-900 text-gray-400 dark:text-gray-500 flex items-center justify-center border border-gray-200 dark:border-gray-700 font-bold text-xs shrink-0">#<?php echo e($index + 1); ?></div>
                                    <?php endif; ?>
                                    <div class="min-w-0 flex-1">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <h4 class="text-sm font-bold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2" title="<?php echo e($res->nama_dinas); ?>"><?php echo e($res->nama_dinas); ?></h4>
                                        </div>
                                ...
                                <div class="shrink-0">
                                    <?php if($res->tingkat_disiplin >= 90): ?>
                                    ...
                                    <?php elseif($res->tingkat_disiplin >= 70): ?>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-100 dark:border-gray-700 space-y-3">
                                <div class="grid grid-cols-3 gap-2 text-center">
                                    <div>
                                        ...
                                        <p class="text-sm font-black text-gray-900 dark:text-gray-100 font-mono mt-0.5"><?php echo e($res->total_attendances); ?></p>
                                    </div>
                                    <div class="border-x border-gray-200 dark:border-gray-700">
                                        ...
                                        <?php if($res->total_pelanggaran > 0): ?>
                                            <p class="text-sm font-black text-rose-600 dark:text-rose-400 font-mono mt-0.5"><?php echo e($res->total_pelanggaran); ?></p>
                                        <?php else: ?>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] font-bold text-gray-600 dark:text-gray-300 mt-0.5 leading-tight">
                                            <span class="text-orange-600 dark:text-orange-400"><?php echo e($res->total_terlambat); ?></span> Telat<br>
                                            <span class="text-rose-600 dark:text-rose-400"><?php echo e($res->total_alpa); ?></span> Alpa
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="px-2 py-0.5 rounded text-[10px] font-black font-mono <?php echo e($textColor); ?>">
                                        <?php echo e(number_format($res->tingkat_disiplin, 1)); ?>%
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden" x-data="{ showDetail: false }">
                                <button type="button" @click="showDetail = !showDetail" class="w-full flex items-center justify-between px-3 py-2 text-xs font-bold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition">
                                    ...
                                    <span class="text-[10px] text-gray-400 dark:text-gray-500">Hadir <?php echo e($res->total_hadir); ?> | Sakit <?php echo e($res->total_sakit); ?> | Izin <?php echo e($res->total_izin); ?></span>
                                ...
                                <div x-show="showDetail" x-transition.opacity x-cloak class="border-t border-gray-100 dark:border-gray-700 p-3 space-y-2">
                                    <?php if(count($res->pelanggar_list) > 0): ?>
                                        ...
                                        <div class="flex items-start justify-between gap-2 py-1.5 border-b border-gray-100 dark:border-gray-700/60 last:border-0">
                                            <div class="min-w-0">
                                                <p class="text-xs font-bold text-gray-900 dark:text-gray-100"><?php echo e($p['nama']); ?></p>
                                                <p class="text-[10px] text-gray-500 dark:text-gray-400"><?php echo e($p['kampus']); ?> · <?php echo e($p['posisi']); ?></p>
                                            </div>
                                            <div class="flex gap-2 shrink-0 text-[10px] font-mono">
                                                <span class="text-orange-600 dark:text-orange-400 font-bold">Telat <?php echo e($p['terlambat']); ?>x</span>
                                                <span class="text-rose-600 dark:text-rose-400 font-bold">Alpa <?php echo e($p['alpa']); ?>x</span>
                                            </div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\laporan\instansi_disiplin.blade.php ENDPATH**/ ?>