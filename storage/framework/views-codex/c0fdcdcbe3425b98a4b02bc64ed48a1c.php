...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-2">
                ...
                <?php echo e(__('Tambah Instansi Baru')); ?>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="<?php echo e(route('admin.instansi.index')); ?>" class="group inline-flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <form action="<?php echo e(route('admin.instansi.store')); ?>" method="POST" enctype="multipart/form-data" class="p-8">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_dinas" value="<?php echo e(old('nama_dinas')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="kode_unit_kerja" value="<?php echo e(old('kode_unit_kerja')); ?>"
                                        class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-teal-500 focus:ring focus:ring-teal-500/20 transition shadow-sm text-sm" 
                                        required
                                        oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                        oninput="this.setCustomValidity('')">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="alamat" rows="1"
                                        ...
                                        oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                        oninput="this.setCustomValidity('')"><?php echo e(old('alamat')); ?></textarea>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        <div class="relative">
                                            ...
                                            <input type="text" name="longitude" id="longitude" value="<?php echo e(old('longitude')); ?>"
                                                class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-blue-500 focus:ring focus:ring-blue-500/20 text-sm font-mono" 
                                    ...
                                    <div>
                                        <div class="relative">
                                            ...
                                            <input type="number" name="radius_absen" id="radius_absen" value="<?php echo e(old('radius_absen', 50)); ?>"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email_admin" value="<?php echo e(old('email_admin')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end sm:space-x-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <a href="<?php echo e(route('admin.instansi.index')); ?>" class="w-full sm:w-auto px-6 py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-200 dark:hover:bg-gray-600 transition text-sm text-center">
                            Batal
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\instansi\create.blade.php ENDPATH**/ ?>