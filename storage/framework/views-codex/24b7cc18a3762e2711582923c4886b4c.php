...
<body>
    ...
    <table class="data">
        ...
        <tbody>
            <?php $__currentLoopData = $jurusans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="text-align: center;"><?php echo e($index + 1); ?></td>
                <td><?php echo e($data->required_major); ?></td>
                <td style="text-align: center;"><?php echo e($data->total_lowongan); ?> Posisi</td>
                <td style="text-align: center;"><?php echo e($data->total_kuota); ?> Orang</td>
            </tr>
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\pdf\admin_kota\demografi_jurusan.blade.php ENDPATH**/ ?>