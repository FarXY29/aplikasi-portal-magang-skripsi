     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-teal-700 to-emerald-600 dark:from-teal-400 dark:to-emerald-300 leading-tight flex items-center gap-3 drop-shadow-sm">
                ...
                <?php echo e(__('Edit Lowongan Magang')); ?>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="bg-white dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-100/60 dark:border-gray-700/60 overflow-hidden transform transition-all">
                ...
                <div class="p-8 md:p-10">
                    <form action="<?php echo e(route('dinas.lowongan.update', $loker->id)); ?>" method="POST" id="lowongan-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                    <input type="text" name="judul_posisi" id="judul_posisi" value="<?php echo e(old('judul_posisi', $loker->judul_posisi)); ?>" 
                                        class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['judul_posisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-teal-500 focus:ring-teal-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-bold text-slate-800 dark:text-gray-100 text-lg placeholder-slate-400 dark:placeholder-gray-600" required
                                        oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                        oninput="this.setCustomValidity('')">
                                    <?php $__errorArgs = ['judul_posisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
                                    <span class="text-red-500 text-xs mt-2 ml-1 font-bold flex items-center gap-1"><i class="fas fa-exclamation-triangle"></i> <?php echo e($message); ?></span> 
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                        <input type="text" name="required_major" id="required_major" value="<?php echo e(old('required_major', $loker->required_major)); ?>" 
                                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['required_major'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-teal-500 focus:ring-teal-500/10 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-medium text-slate-800 dark:text-gray-100 placeholder-slate-400 dark:placeholder-gray-600"
                                            placeholder="Contoh: Teknik Informatika, DKV">
                                        <?php $__errorArgs = ['required_major'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                        <input type="number" name="kuota" id="kuota" value="<?php echo e(old('kuota', $loker->kuota)); ?>" min="0" 
                                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['kuota'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-emerald-500 focus:ring-emerald-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-medium text-slate-800 dark:text-gray-100" required
                                            oninvalid="this.setCustomValidity('Harap isi bidang ini.')"
                                            oninput="this.setCustomValidity('')">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                        <select name="status" id="status" class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-amber-500 focus:ring-amber-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-bold text-slate-800 dark:text-gray-100 cursor-pointer appearance-none">
                                            <option value="buka" class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" <?php echo e($loker->status == 'buka' ? 'selected' : ''); ?>>🟢 Dibuka (Aktif)</option>
                                            <option value="tutup" class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100" <?php echo e($loker->status == 'tutup' ? 'selected' : ''); ?>>🔴 Ditutup (Arsip)</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="relative transition-all duration-300 group-focus-within:drop-shadow-md">
                                        <input type="date" name="batas_daftar" id="batas_daftar" value="<?php echo e(old('batas_daftar', \Carbon\Carbon::parse($loker->batas_daftar)->format('Y-m-d'))); ?>" 
                                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-gray-900 border <?php $__errorArgs = ['batas_daftar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-500 focus:ring-red-500/10 <?php else: ?> border-slate-200 dark:border-gray-700 focus:border-indigo-500 focus:ring-indigo-500/10 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> rounded-2xl focus:bg-white dark:focus:bg-gray-800 focus:ring-4 transition-all font-medium text-slate-800 dark:text-gray-100 [color-scheme:light] dark:[color-scheme:dark]">
                                        <?php $__errorArgs = ['batas_daftar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="relative group">
                                ...
                                <div class="rounded-2xl overflow-hidden border <?php $__errorArgs = ['deskripsi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus-within:ring-red-500/10 focus-within:border-red-500 <?php else: ?> border-slate-200 dark:border-gray-700 focus-within:ring-teal-500/10 focus-within:border-teal-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> shadow-sm focus-within:ring-4 transition-all duration-300 bg-white dark:bg-gray-800">
                                    <textarea id="editor" name="deskripsi" class="w-full border-0 focus:ring-0 bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100"><?php echo e(old('deskripsi', $loker->deskripsi)); ?></textarea>
                                </div>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_instansi\lowongan\edit.blade.php ENDPATH**/ ?>