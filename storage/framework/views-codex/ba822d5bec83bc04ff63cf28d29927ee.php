     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-xl md:text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Laporan Statistik Instansi')); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center print:hidden">
                ...
                <div class="sm:ml-auto flex-shrink-0 flex flex-wrap gap-2 justify-center">
                    <a href="<?php echo e(route('admin.laporan.print', request()->query())); ?>" target="_blank" class="inline-flex items-center px-4 py-2.5 bg-white dark:bg-gray-800 text-teal-900 dark:text-teal-200 rounded-xl hover:bg-teal-50 dark:hover:bg-gray-700 border border-transparent dark:border-gray-700 transition text-xs font-extrabold shadow-xs hover:shadow active:scale-95" title="Download PDF">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total seluruh instansi/dinas Pemerintah Kota Banjarmasin yang terdaftar dalam sistem portal magang.">
                    ...
                    <p class="text-xl md:text-2xl font-black text-gray-800 dark:text-gray-100 font-mono tracking-tight"><?php echo e(number_format($stats['total_instansi'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah posisi lowongan magang berstatus terbuka (buka) yang sedang ditawarkan seluruh instansi.">
                    ...
                    <p class="text-xl md:text-2xl font-black text-blue-600 dark:text-blue-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_lowongan'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Total akumulasi berkas pendaftaran/lamaran peserta yang masuk ke seluruh instansi Pemko.">
                    ...
                    <p class="text-xl md:text-2xl font-black text-indigo-600 dark:text-indigo-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_pelamar'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Jumlah peserta magang yang telah diterima (status 'diterima') atau telah lulus/selesai (status 'selesai') secara akumulatif di seluruh instansi.">
                    ...
                    <p class="text-xl md:text-2xl font-black text-emerald-600 dark:text-emerald-400 font-mono tracking-tight"><?php echo e(number_format($stats['total_diterima'])); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help bg-gradient-to-br from-teal-50/50 via-white to-indigo-50/30 dark:from-teal-950/20 dark:via-gray-800 dark:to-indigo-950/20" title="Rata-rata persentase kelulusan seleksi tingkat kota. Rumus: (Total Diterima / Total Pelamar) x 100%.">
                    ...
                    <p class="text-xl md:text-2xl font-black text-amber-600 dark:text-amber-400 font-mono tracking-tight"><?php echo e($stats['avg_seleksi_rate']); ?>%</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-5 shadow-xs border border-gray-100 dark:border-gray-700 text-center hover:shadow-md transition cursor-help" title="Instansi/dinas dengan jumlah pendaftar terbanyak se-Kota Banjarmasin.">
                    ...
                    <p class="text-xs font-extrabold text-rose-600 dark:text-rose-400 truncate w-full px-1" title="<?php echo e($stats['fav_dinas']); ?>"><?php echo e($stats['fav_dinas']); ?></p>
            ...
            <div class="bg-gradient-to-r from-teal-800 via-teal-700 to-emerald-700 dark:from-teal-900 dark:via-teal-950 dark:to-emerald-950 rounded-3xl p-6 text-white shadow-md border border-teal-600/30 flex flex-col sm:flex-row items-center gap-6">
                ...
                <div class="text-center sm:text-left flex-grow space-y-1">
                    ...
                    <h2 class="text-xl font-extrabold mt-0.5 tracking-tight">Maju Bersama <?php echo e($stats['total_instansi']); ?> Instansi Pemerintahan</h2>
                    <p class="text-xs text-teal-50/90 font-medium">Tingkat seleksi kelulusan peserta kota berada pada kisaran <?php echo e($stats['avg_seleksi_rate']); ?>%.</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-gray-50/50 dark:bg-gray-900/50">
                    ...
                    <form action="<?php echo e(route('admin.laporan')); ?>" method="GET" class="flex flex-col sm:flex-row gap-2.5 items-center w-full lg:w-auto">
                        ...
                        <div class="w-full sm:w-48">
                            <select name="sort" class="w-full py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl text-xs font-bold text-gray-800 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500 shadow-xs cursor-pointer [color-scheme:dark]">
                                <option value="pelamar_desc" <?php echo e(request('sort') == 'pelamar_desc' ? 'selected' : ''); ?>>Peminat Terbanyak</option>
                                <option value="pelamar_asc" <?php echo e(request('sort') == 'pelamar_asc' ? 'selected' : ''); ?>>Peminat Tersedikit</option>
                                <option value="name_asc" <?php echo e(request('sort') == 'name_asc' ? 'selected' : ''); ?>>Nama Instansi (A - Z)</option>
                                <option value="name_desc" <?php echo e(request('sort') == 'name_desc' ? 'selected' : ''); ?>>Nama Instansi (Z - A)</option>
                                <option value="lowongan_desc" <?php echo e(request('sort') == 'lowongan_desc' ? 'selected' : ''); ?>>Lowongan Terbanyak</option>
                                <option value="lowongan_asc" <?php echo e(request('sort') == 'lowongan_asc' ? 'selected' : ''); ?>>Lowongan Tersedikit</option>
                                <option value="seleksi_desc" <?php echo e(request('sort') == 'seleksi_desc' ? 'selected' : ''); ?>>Rasio Kelulusan Tertinggi</option>
                                <option value="seleksi_asc" <?php echo e(request('sort') == 'seleksi_asc' ? 'selected' : ''); ?>>Rasio Kelulusan Terendah</option>
                            </select>
                        </div>
                        ...
                        <div class="flex gap-2 w-full sm:w-auto">
                            ...
                            <?php if(request()->anyFilled(['search', 'sort'])): ?>
                                <a href="<?php echo e(route('admin.laporan')); ?>" class="px-3 py-2 border border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl font-bold text-xs shadow-xs transition flex items-center justify-center">
                                    Reset
                                </a>
                            <?php endif; ?>
                        </div>
                            ...
                            <tr class="hover:bg-teal-50/15 dark:hover:bg-teal-950/20 transition group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-bold text-gray-900 dark:text-gray-100 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition"><?php echo e($data['nama_dinas']); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="text-gray-700 dark:text-gray-300 font-bold bg-gray-100 dark:bg-gray-900 px-3 py-1 rounded-full text-xs border border-gray-200 dark:border-gray-700">
                                        <?php echo e($data['lowongan_aktif']); ?> Posisi
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="px-3 py-1 bg-blue-50 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 rounded-full font-bold text-xs border border-blue-200 dark:border-blue-800/60">
                                        <?php echo e($data['total_pelamar']); ?> Orang
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="px-3 py-1 bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 rounded-full font-bold text-xs border border-emerald-200 dark:border-emerald-800/60">
                                        <?php echo e($data['total_magang']); ?> Orang
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col items-center gap-1">
                                        <span class="font-black text-gray-900 dark:text-gray-100 font-mono"><?php echo e($data['seleksi_rate']); ?>%</span>
                                        ...
                                        <div class="w-24 h-1.5 bg-gray-100 dark:bg-gray-900 rounded-full overflow-hidden border border-transparent dark:border-gray-700">
                                            <div class="h-full rounded-full bg-gradient-to-r from-teal-500 to-emerald-500" style="width: <?php echo e($data['seleksi_rate']); ?>%"></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="text-gray-600 dark:text-gray-400 font-bold italic text-xs">
                                        <?php echo e($data['avg_peminat']); ?> <span class="text-[10px] text-gray-400 dark:text-gray-500 font-normal">pelamar/posisi</span>
                                    </span>
                                </td>
                            </tr>
                ...
                <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <div class="p-4 space-y-3.5">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-bold text-gray-900 dark:text-gray-100 text-sm leading-tight"><?php echo e($data['nama_dinas']); ?></span>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <span class="font-black text-gray-900 dark:text-gray-100 font-mono text-sm"><?php echo e($data['seleksi_rate']); ?>%</span>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\laporan.blade.php ENDPATH**/ ?>