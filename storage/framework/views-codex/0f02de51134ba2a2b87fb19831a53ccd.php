...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => 'Edit Data Pengguna','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Data Pengguna','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                ['label' => 'Manajemen User', 'url' => route('admin.users.index')],
                ['label' => 'Edit']
            ])]); ?>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 dark:border-gray-700">
                ...
                <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" class="p-8">
                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'name','name' => 'name','type' => 'text','icon' => 'fas fa-user','value' => ''.e(old('name', $user->name)).'','placeholder' => 'Nama Lengkap User','required' => true,'oninvalid' => 'this.setCustomValidity(\'Harap isi bidang ini.\')','oninput' => 'this.setCustomValidity(\'\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'name','name' => 'name','type' => 'text','icon' => 'fas fa-user','value' => ''.e(old('name', $user->name)).'','placeholder' => 'Nama Lengkap User','required' => true,'oninvalid' => 'this.setCustomValidity(\'Harap isi bidang ini.\')','oninput' => 'this.setCustomValidity(\'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','name' => 'email','type' => 'email','icon' => 'fas fa-envelope','value' => ''.e(old('email', $user->email)).'','placeholder' => 'email@example.com','required' => true,'oninvalid' => 'this.setCustomValidity(\'Harap isi bidang ini.\')','oninput' => 'this.setCustomValidity(\'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'phone','name' => 'phone','type' => 'text','value' => ''.e(old('phone', $user->phone)).'','placeholder' => '08xxxxxxxxxx']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'phone','name' => 'phone','type' => 'text','value' => ''.e(old('phone', $user->phone)).'','placeholder' => '08xxxxxxxxxx']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                            ...
                            <div>
                                <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'password','value' => 'Password Baru (Kosongkan jika tidak diubah)','class' => 'mb-2 font-bold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'password','value' => 'Password Baru (Kosongkan jika tidak diubah)','class' => 'mb-2 font-bold']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'password','name' => 'password','type' => 'password','icon' => 'fas fa-lock','placeholder' => 'Minimal 8 karakter']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','name' => 'password','type' => 'password','icon' => 'fas fa-lock','placeholder' => 'Minimal 8 karakter']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <select name="role" id="roleSelect" onchange="toggleFields()"
                                        ...
                                        <option value="peserta" <?php echo e($currentRole === 'peserta' ? 'selected' : ''); ?>>Peserta Magang</option>
                                        <option value="pembimbing" <?php echo e($currentRole === 'pembimbing' ? 'selected' : ''); ?>>Dosen / Guru Pembimbing</option>
                                        <option value="pembimbing_lapangan" <?php echo e($currentRole === 'pembimbing_lapangan' ? 'selected' : ''); ?>>Pembimbing Lapangan (Pegawai)</option>
                                        <option value="admin_instansi" <?php echo e($currentRole === 'admin_instansi' ? 'selected' : ''); ?>>Admin Instansi</option>
                                        <?php if($portalRole === 'admin_kota'): ?>
                                            <option value="admin_kota" <?php echo e($currentRole === 'admin_kota' ? 'selected' : ''); ?>>Super Admin Kota</option>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 p-5 rounded-xl border border-gray-200 dark:border-gray-700 transition-all duration-300">
                                ...
                                <div id="instansiDinasField" class="<?php echo e(in_array($currentRole, ['admin_instansi', 'pembimbing_lapangan']) ? '' : 'hidden'); ?>">
                                    ...
                                    <select name="instansi_id" class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 text-sm focus:ring-blue-500 focus:border-blue-500">
                                        ...
                                        <?php $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instansi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($instansi->id); ?>" <?php echo e(old('instansi_id', $user->instansi_id) == $instansi->id ? 'selected' : ''); ?>>
                                                <?php echo e($instansi->nama_dinas); ?>
                                ...
                                <div id="asalSekolahField" class="<?php echo e(in_array($currentRole, ['peserta', 'pembimbing']) ? '' : 'hidden'); ?>">
                                    ...
                                    <input type="text" name="asal_instansi" value="<?php echo e(old('asal_instansi', $user->asal_instansi)); ?>"
                                ...
                                <div id="noneField" class="<?php echo e($currentRole === 'admin_kota' ? '' : 'hidden'); ?> text-center text-gray-400 dark:text-gray-500 text-sm py-2">
                            ...
                            <?php if($user->created_at): ?>
                                <div class="text-xs text-gray-400 dark:text-gray-500 pt-2 border-t border-gray-100 dark:border-gray-700">
                                    Terdaftar sejak: <?php echo e($user->created_at->translatedFormat('d F Y')); ?>
                    ...
                    <div class="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-end sm:space-x-3 mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="w-full sm:w-auto px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-50 dark:hover:bg-gray-700 transition shadow-sm text-sm text-center">
                            Batal
                        </a>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_kota\users\edit.blade.php ENDPATH**/ ?>