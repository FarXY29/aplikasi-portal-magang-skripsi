     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Pendaftaran Penempatan Otomatis')); ?>
                        ...
                        <div class="p-6 space-y-5">
                            <div class="feature-step-item flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">Sistem hanya akan menempatkan Anda pada posisi yang sesuai dengan jurusan Anda saat ini: <strong class="text-gray-800 dark:text-gray-200"><?php echo e(Auth::user()->major ?? '-'); ?></strong>.</p>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8">
                            ...
                            <form action="<?php echo e(route('peserta.apply_automatic.store')); ?>" method="POST" enctype="multipart/form-data" id="applyForm">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\peserta\apply_automatic.blade.php ENDPATH**/ ?>