...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full">
            ...
            <div class="text-xs font-bold text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 px-3.5 py-1.5 rounded-xl shadow-xs border border-gray-200 dark:border-gray-700">
                Total Peserta: <span class="font-black text-teal-600 dark:text-teal-400"><?php echo e($participants->total()); ?></span>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="space-y-5 font-[Inter] py-4">
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4">
            <form method="GET" action="<?php echo e(route('admin.users.logbooks')); ?>" class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto flex-grow max-w-xl">
                ...
                <div class="flex gap-2 w-full sm:w-auto">
                    ...
                    <?php if(request()->filled('search')): ?>
                        <a href="<?php echo e(route('admin.users.logbooks')); ?>" class="px-3.5 py-2 rounded-xl border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 transition text-xs font-bold flex items-center justify-center">
                            Reset
                        </a>
                    <?php endif; ?>
                </div>
                        ...
                        <tr class="table-row hover:bg-teal-50/15 dark:hover:bg-gray-900/60 group transition">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3.5 min-w-0">
                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors truncate"><?php echo e($user->name); ?></div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 font-medium truncate"><?php echo e($user->email); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center text-xs text-gray-700 dark:text-gray-300 font-bold truncate">
                                    ...
                                    <span class="truncate" title="<?php echo e($user->asal_instansi); ?>"><?php echo e($user->asal_instansi ?? '-'); ?></span>
                                </div>
                            </td>

                            
                            <td class="px-5 py-3.5">
                                <?php if($user->applications->isNotEmpty()): ?>
                                    <?php
                                    ...
                                    ?>
                                    <div class="flex items-center px-2.5 py-1 rounded-lg border <?php echo e($statusColor); ?> w-fit text-xs font-bold">
                                        <i class="fas fa-building mr-1.5 text-[10px] flex-shrink-0"></i>
                                        <span class="truncate max-w-[180px] sm:max-w-[220px]" title="<?php echo e($app->position->instansi->nama_dinas); ?>">
                                            <?php echo e($app->position->instansi->nama_dinas); ?>
                ...
                <div class="p-4 space-y-3.5 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate mt-0.5"><?php echo e($user->asal_instansi ?? 'Instansi (-)'); ?></p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <?php if($user->applications->isNotEmpty()): ?>
                                <p class="text-xs font-bold text-gray-800 dark:text-gray-200 flex items-center leading-tight">
                                    ...
                                    <?php echo e($user->applications->first()->position->instansi->nama_dinas); ?>
                    ...
                    <div class="pt-1">
                        <?php if($user->applications->isNotEmpty()): ?>
                            <a href="<?php echo e(route('admin.users.logbooks.show', $user->id)); ?>" class="flex items-center justify-center w-full px-4 py-2 bg-teal-600 dark:bg-teal-500 text-white rounded-xl text-xs font-bold hover:bg-teal-700 transition shadow-2xs">
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/admin_kota/users/logbooks.blade.php ENDPATH**/ ?>