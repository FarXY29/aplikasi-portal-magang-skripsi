     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="text-sm text-gray-500 dark:text-gray-400 font-medium bg-white dark:bg-gray-800 px-4 py-1.5 rounded-full shadow-sm border border-gray-100 dark:border-gray-700">
                Total Aktivitas: <span class="font-bold text-teal-600 dark:text-teal-400"><?php echo e($logs->count()); ?></span>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100"><?php echo e($app->user->name); ?></h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1.5 mt-0.5">
                            <i class="fas fa-briefcase text-gray-400 dark:text-gray-500 text-xs"></i> <?php echo e($app->position->judul_posisi); ?>
                ...
                <div class="flex gap-4 text-center">
                    <div class="px-4 py-2 bg-green-50 dark:bg-green-950/60 rounded-xl border border-green-100 dark:border-green-800/60">
                        ...
                        <p class="text-xl font-black text-green-700 dark:text-green-400"><?php echo e($logs->where('status_validasi', 'disetujui')->count()); ?></p>
                    </div>
                    <div class="px-4 py-2 bg-amber-50 dark:bg-amber-950/60 rounded-xl border border-amber-100 dark:border-amber-800/60">
                        ...
                        <p class="text-xl font-black text-amber-700 dark:text-amber-400"><?php echo e($logs->where('status_validasi', 'pending')->count()); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition duration-300">
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div class="lg:w-1/4 bg-gray-50 dark:bg-gray-900 p-6 flex flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-gray-100 dark:border-gray-700 text-center">
                            <div class="mb-3">
                                <span class="block text-2xl font-black text-gray-800 dark:text-gray-200"><?php echo e(\Carbon\Carbon::parse($log->tanggal)->format('d')); ?></span>
                                <span class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase"><?php echo e(\Carbon\Carbon::parse($log->tanggal)->format('M Y')); ?></span>
                            </div>
                            
                            <?php if($log->bukti_foto_path): ?>
                                <div class="relative group w-full h-32 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 cursor-pointer shadow-sm" onclick="openImageModal('<?php echo e(route('storage.access', ['type' => 'logbook', 'filename' => basename($log->bukti_foto_path)])); ?>', '_blank')">
                            ...
                            <?php if($log->komentar_pembimbing_lapangan): ?>
                                <div class="mt-4 bg-indigo-50/70 dark:bg-indigo-950/40 p-3.5 rounded-2xl border border-indigo-100 dark:border-indigo-900/50 flex gap-3 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-indigo-700 dark:text-indigo-300 italic">"<?php echo e($log->komentar_pembimbing_lapangan); ?>"</p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="lg:w-1/4 bg-gray-50 dark:bg-gray-900 p-6 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-gray-700">
                            ...
                            <div class="mb-4 text-center">
                                ...
                                ?>
                                <span class="px-4 py-1.5 rounded-full text-xs font-black uppercase border <?php echo e($style); ?>">
                                    <?php echo e($log->status_validasi); ?>

                                </span>
                            </div>

                            <?php if($log->status_validasi == 'pending'): ?>
                                <form action="<?php echo e(route('dinas.logbook.validasi', $log->id)); ?>" method="POST" class="space-y-3">
                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_instansi\peserta\detail.blade.php ENDPATH**/ ?>