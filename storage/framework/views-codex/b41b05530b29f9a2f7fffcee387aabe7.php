      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-grow w-full">
          ...
          <div class="bg-gradient-to-r from-teal-900 via-teal-950 to-emerald-950 dark:from-teal-950 dark:via-gray-900 dark:to-emerald-950 rounded-[2.5rem] p-6 sm:p-10 text-white shadow-xl shadow-teal-950/35 mb-12 overflow-hidden relative border border-teal-800/40 w-full">
              ...
              <div class="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch lg:items-center justify-between relative z-10 w-full">
                  ...
                  <a href="<?php echo e(route('peserta.apply_automatic.form')); ?>" class="shrink-0 bg-white dark:bg-gray-800 text-teal-950 dark:text-teal-200 hover:bg-teal-50 dark:hover:bg-gray-700 px-6 py-4 rounded-2xl font-extrabold shadow-md hover:shadow-lg transition transform hover:-translate-y-0.5 active:scale-98 text-center text-xs uppercase tracking-wider flex items-center justify-center gap-2">
          ...
          <!-- Vacancies Section Header -->
           <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4 w-full">
               ...
               <?php if(request()->anyFilled(['posisi', 'instansi_id', 'jurusan', 'search'])): ?>
                   <a href="<?php echo e(route('home')); ?>#lowongan" class="group flex items-center bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800/60 px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold hover:bg-rose-100 dark:hover:bg-rose-900/60 transition duration-300 self-start md:self-auto shadow-xs">
           ...
           <div class="bg-white dark:bg-gray-800 p-5 sm:p-8 rounded-[2.5rem] shadow-xs border border-slate-100 dark:border-gray-700 mb-8 w-full">
               <form action="<?php echo e(route('home')); ?>#lowongan" method="GET" id="filter-form" onsubmit="event.preventDefault(); let params = new URLSearchParams(new FormData(this)); for (let [k, v] of Array.from(params.entries())) { if (!v) params.delete(k); } window.location.href = '<?php echo e(route('home')); ?>?' + params.toString() + '#lowongan';" class="w-full">
                   ...
                   <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-end w-full">
                           ...
                           <div class="relative w-full group">
                               <select name="instansi_id" class="w-full pl-5 pr-12 py-4 border border-slate-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-base lg:text-sm font-bold bg-slate-50/50 dark:bg-gray-900 focus:bg-white dark:focus:bg-gray-900 transition duration-300 appearance-none cursor-pointer text-slate-800 dark:text-gray-100 shadow-xs [color-scheme:dark]">
                                   ...
                                   <?php $__currentLoopData = $instansis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instansi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($instansi->id); ?>" <?php echo e(request('instansi_id') == $instansi->id ? 'selected' : ''); ?> class="bg-white dark:bg-gray-900 text-slate-800 dark:text-gray-100">
                                           <?php echo e(Str::limit($instansi->nama_dinas, 45)); ?>
                       ...
                       <div class="lg:col-span-5 w-full">
                           ...
                           <div class="relative w-full">
                               <input type="text" name="jurusan" id="jurusan-input" value="<?php echo e(request('jurusan')); ?>" placeholder="Contoh: Informatika, Akuntansi, SMK..." 
           ...
           <div class="flex items-center gap-3.5 overflow-x-auto pb-4 mb-8 no-scrollbar w-full max-w-full">
               ...
               <a href="<?php echo e(route('home')); ?>#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(!request('jurusan') && !request('instansi_id') && !request('search') ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   ✨ Semua Posisi
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=Informatika#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'Informatika') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   💻 Informatika & IT
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=Akuntansi#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'Akuntansi') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   📊 Akuntansi & Keuangan
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=Administrasi#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'Administrasi') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   🏛️ Administrasi
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=SMK#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'SMK') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   🏫 Khusus SMK
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=SMA#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'SMA') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   🎒 Khusus SMA
               </a>
               <a href="<?php echo e(route('home')); ?>?jurusan=S1#lowongan" class="shrink-0 px-4 py-2 rounded-full text-xs font-extrabold transition duration-300 <?php echo e(stripos(request('jurusan'), 'S1') !== false ? 'bg-gradient-to-r from-teal-600 to-emerald-600 text-white shadow-xs' : 'bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 border border-slate-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-500 hover:text-teal-600 dark:hover:text-teal-400 shadow-xs'); ?>">
                   🎓 Mahasiswa (S1/D3)
               </a>
           </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full">
                          ...
                          <div @click="showModal = true" class="cursor-pointer group bg-white dark:bg-gray-800 rounded-[2rem] border border-slate-200/80 dark:border-gray-700 overflow-hidden hover:shadow-xl hover:border-teal-300 dark:hover:border-teal-500 hover:-translate-y-1 active:scale-[0.99] transition-all duration-300 flex flex-col h-full relative shadow-xs w-full">
                              ...
                              <div class="px-6 pt-6 pb-4 flex items-center justify-between gap-3 border-b border-slate-50 dark:border-gray-700/60 shrink-0">
                                  <div class="flex flex-wrap items-center gap-2">
                                      <span class="inline-flex items-center gap-1.5 bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60 text-[10px] px-2.5 py-1 rounded-lg font-black uppercase tracking-wider">
                                          ...
                                          <?php echo e($loker->status); ?>

                                      </span>
                                      <?php if($loker->kuota < 3): ?>
                                          <span class="inline-flex items-center gap-1 bg-rose-50 dark:bg-rose-950/60 text-rose-600 dark:text-rose-300 border border-rose-200/60 dark:border-rose-800/60 text-[10px] px-2.5 py-1 rounded-lg font-black uppercase tracking-wider">
                                              🔥 Sisa <?php echo e($loker->kuota); ?> Kursi
                                          </span>
                                      <?php else: ?>
                              ...
                              <div class="p-6 pt-5 pb-4 flex items-start gap-4 shrink-0">
                                  ...
                                  <div class="min-w-0 flex-grow">
                                      <h3 class="text-base sm:text-lg font-black text-slate-800 dark:text-gray-100 group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors duration-300 line-clamp-1 leading-snug" title="<?php echo e($loker->judul_posisi); ?>">
                                      ...
                                      <p class="text-xs text-slate-500 dark:text-gray-400 flex items-center font-bold mt-1.5">
                                          ...
                                          <span class="truncate"><?php echo e($loker->instansi->nama_dinas); ?></span>
                                      </p>
                                  </div>
                              </div>
                              ...
                              <div class="px-6 py-2 flex-grow flex flex-col justify-start">
                                  <div class="flex flex-wrap items-center gap-2 mb-4">
                                      <span class="inline-flex items-center px-3 py-1 rounded-xl text-[11px] font-bold bg-slate-100 dark:bg-gray-900 text-slate-700 dark:text-gray-300 border border-slate-200 dark:border-gray-700 max-w-full">
                                          ...
                                          <span class="truncate" title="<?php echo e($loker->required_major); ?>"><?php echo e($loker->required_major); ?></span>
                                      </span>
                                      <?php if(preg_match('/SMA|SMK/i', $loker->required_major)): ?>
                                  ...
                                  <div class="prose prose-sm text-slate-500 dark:text-gray-400 text-xs sm:text-sm leading-relaxed line-clamp-2 mb-6 font-medium">
                                      <?php echo strip_tags($loker->deskripsi); ?>
                              ...
                              <div class="p-5 pt-3 bg-slate-50 dark:bg-gray-900 border-t border-slate-100 dark:border-gray-700/60 mt-auto shrink-0 flex items-center justify-between gap-3">
                                  <?php if(auth()->guard()->check()): ?>
                                      <?php if(auth()->user()->role == 'peserta'): ?>
                                          ...
                                          <?php if($isMatch): ?>
                                              <a @click.stop href="<?php echo e(route('peserta.daftar.form', $loker->id)); ?>" class="w-full bg-teal-600 hover:bg-teal-700 text-white py-3.5 px-4 rounded-2xl font-bold shadow-md active:scale-98 transition text-center text-xs uppercase tracking-wider flex items-center justify-center gap-2">
                                          ...
                                          <?php endif; ?>
                                      <?php elseif(auth()->user()->role == 'admin_kota' || auth()->user()->role == 'admin_instansi'): ?>
                          ...
                          <div x-show="showModal" style="display: none;" class="fixed inset-0 z-[100] flex justify-end items-end sm:items-stretch" role="dialog" aria-modal="true">
                              ...
                              <div x-show="showModal" 
                                  ...
                                  <div class="px-6 sm:px-8 pt-6 pb-8 overflow-y-auto flex-grow space-y-6">
                                      ...
                                      <div class="flex flex-col sm:flex-row items-start gap-4 pb-2">
                                          ...
                                          <div class="space-y-1">
                                              ...
                                              <p class="text-xs sm:text-sm font-bold text-teal-600 dark:text-teal-400">
                                                  <?php echo e($loker->instansi->nama_dinas); ?>

                                              </p>
                                              <?php if(!empty($loker->instansi->alamat)): ?>
                                                  <p class="text-xs text-slate-500 dark:text-gray-400 flex items-start gap-2 pt-1 leading-relaxed font-medium">
                                                      ...
                                                      <span><?php echo e($loker->instansi->alamat); ?></span>
                                                  </p>
                                              <?php endif; ?>
                                          </div>
                                      </div>
                                      ...
                                      <div class="grid grid-cols-2 gap-3">
                                          ...
                                          <div class="bg-slate-50 dark:bg-gray-900 border border-slate-100 dark:border-gray-700 rounded-2xl p-3.5 flex flex-col justify-between">
                                              ...
                                              <span class="text-xs font-bold text-slate-800 dark:text-gray-100 mt-1 flex items-center gap-1.5">
                                                  ...
                                                  <span><?php echo e($loker->kuota); ?> Posisi Tersedia</span>
                                              </span>
                                          </div>
                                          ...
                                          <div class="bg-slate-50 dark:bg-gray-900 border border-slate-100 dark:border-gray-700 rounded-2xl p-3.5 flex flex-col justify-between">
                                              ...
                                              <span class="text-xs font-bold text-slate-800 dark:text-gray-100 mt-1 flex items-center gap-1.5">
                                                  ...
                                                  <span><?php echo e(\Carbon\Carbon::parse($loker->batas_daftar)->translatedFormat('d F Y')); ?></span>
                                              </span>
                                          </div>
                                          ...
                                          <div class="bg-slate-50 dark:bg-gray-900 border border-slate-100 dark:border-gray-700 rounded-2xl p-3.5 flex flex-col justify-between">
                                              ...
                                              <span class="text-xs font-bold text-slate-800 dark:text-gray-100 mt-1 truncate flex items-center gap-1.5" title="<?php echo e($loker->required_major); ?>">
                                                  <i class="fas fa-graduation-cap text-teal-600 dark:text-teal-400 text-[10px]"></i>
                                                  <span class="truncate"><?php echo e($loker->required_major); ?></span>
                                              </span>
                                          </div>
                                      </div>
                                      ...
                                      <div class="space-y-3">
                                          ...
                                          <div class="bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 space-y-3.5 text-xs sm:text-sm">
                                              <?php if(!empty($loker->instansi->nama_pejabat)): ?>
                                                  <div class="flex items-start gap-3">
                                                      ...
                                                      <div>
                                                          ...
                                                          <span class="font-bold text-slate-800 dark:text-gray-200"><?php echo e($loker->instansi->nama_pejabat); ?></span>
                                                          <span class="block text-[11px] text-slate-500 dark:text-gray-400 mt-0.5"><?php echo e($loker->instansi->jabatan_pejabat); ?> (NIP: <?php echo e($loker->instansi->nip_pejabat); ?>)</span>
                                                      </div>
                                                  </div>
                                              <?php endif; ?>

                                              <?php if(!empty($loker->instansi->jam_mulai_masuk) && !empty($loker->instansi->jam_mulai_pulang)): ?>
                                                  <div class="flex items-start gap-3 border-t border-slate-100 dark:border-gray-800 pt-3">
                                                      ...
                                                      <div>
                                                          ...
                                                          <span class="font-bold text-slate-800 dark:text-gray-200 font-mono"><?php echo e(substr($loker->instansi->jam_mulai_masuk, 0, 5)); ?> s/d <?php echo e(substr($loker->instansi->jam_mulai_pulang, 0, 5)); ?> WITA</span>
                                              ...
                                              <?php if(!empty($loker->instansi->latitude) && !empty($loker->instansi->longitude)): ?>
                                                  <div class="flex items-start gap-3 border-t border-slate-100 dark:border-gray-800 pt-3">
                                                      <div class="w-8 h-8 rounded-xl bg-teal-50 dark:bg-teal-950/60 text-teal-600 dark:text-teal-400 flex items-center justify-center shrink-0 mt-0.5 border border-teal-200 dark:border-teal-800/60">
                                                      ...
                                                      <div class="flex-grow">
                                                          ...
                                                          <span class="text-slate-800 dark:text-gray-200 block font-bold text-xs mt-0.5">Radius: <?php echo e($loker->instansi->radius_absen ?? '100'); ?> meter dari kantor</span>
                                                          <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e($loker->instansi->latitude); ?>,<?php echo e($loker->instansi->longitude); ?>" target="_blank" class="inline-flex items-center gap-1.5 text-teal-600 dark:text-teal-400 font-bold hover:underline mt-2 text-xs">
                                  ...
                                  <div class="px-6 sm:px-8 py-5 border-t border-slate-100 dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center justify-end gap-3 shrink-0 z-20">
                                      ...
                                      <?php if(auth()->guard()->check()): ?>
                                          <?php if(auth()->user()->role == 'peserta' && ($isMatch ?? true)): ?>
                                              <a href="<?php echo e(route('peserta.daftar.form', $loker->id)); ?>" class="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-xl font-bold shadow-md transition text-xs uppercase tracking-wider flex items-center gap-2">
              ...
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                  ...
                  <div class="col-span-full py-16 sm:py-24 text-center">
                      ...
                      <a href="<?php echo e(route('home')); ?>#lowongan" class="inline-flex items-center gap-2 mt-5 bg-teal-600 hover:bg-teal-700 text-white px-5 py-2.5 rounded-xl text-xs font-bold transition shadow-md uppercase tracking-wider">
...
<?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views/public/welcome/_lowongan-grid.blade.php ENDPATH**/ ?>