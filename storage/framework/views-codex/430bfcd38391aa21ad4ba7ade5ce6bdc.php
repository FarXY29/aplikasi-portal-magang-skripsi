             ...
             <div class="grid grid-cols-1 md:grid-cols-12 gap-8 sm:gap-10 pb-12 border-b border-slate-900 text-left w-full">
                 ...
                 <div class="md:col-span-5 flex flex-col items-start gap-4">
                     <div class="flex items-center gap-3">
                         <div class="bg-white dark:bg-gray-800/10 rounded-2xl p-2.5 backdrop-blur-md border border-white/10 flex items-center justify-center">
                             <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-10 h-10 fill-current text-teal-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-10 h-10 fill-current text-teal-400']); ?>
...
<?php endif; ?>
             ...
             <div class="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left text-[11px] sm:text-xs text-slate-500 w-full">
                 <p>&copy; <?php echo e(date('Y')); ?> Dinas Komunikasi, Informatika dan Statistik Kota Banjarmasin. Hak Cipta Dilindungi.</p>
                 
                 <!-- Social Links -->
                 <div class="flex gap-3.5">
                     <a href="#" aria-label="Instagram" class="w-9 h-9 rounded-xl bg-white dark:bg-gray-800/5 hover:bg-teal-600 hover:text-white active:scale-95 transition-all duration-300 flex items-center justify-center text-slate-400"><i class="fab fa-instagram text-sm"></i></a>
                     <a href="#" aria-label="Facebook" class="w-9 h-9 rounded-xl bg-white dark:bg-gray-800/5 hover:bg-teal-600 hover:text-white active:scale-95 transition-all duration-300 flex items-center justify-center text-slate-400"><i class="fab fa-facebook text-sm"></i></a>
                     <a href="#" aria-label="Website Resmi" class="w-9 h-9 rounded-xl bg-white dark:bg-gray-800/5 hover:bg-teal-600 hover:text-white active:scale-95 transition-all duration-300 flex items-center justify-center text-slate-400"><i class="fas fa-globe text-sm"></i></a>
                 </div>
             </div>
         </div>
     </footer>
     ...
     </script><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\public\welcome\_footer.blade.php ENDPATH**/ ?>