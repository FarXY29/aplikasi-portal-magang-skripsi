...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                ...
                <?php echo e(__('Pengaturan Instansi')); ?>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div>
                <a href="<?php echo e(route('dinas.dashboard')); ?>" class="group inline-flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition">
...
<?php endif; ?>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    <form action="<?php echo e(route('dinas.settings.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time" name="jam_mulai_masuk" value="<?php echo e($instansi->jam_mulai_masuk); ?>" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time" name="jam_mulai_pulang" value="<?php echo e($instansi->jam_mulai_pulang); ?>" 
                                        class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500 text-sm font-bold shadow-xs [color-scheme:dark]">
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="any" id="input_latitude" name="latitude" value="<?php echo e(old('latitude', $instansi->latitude ?? '-3.316694')); ?>" required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="any" id="input_longitude" name="longitude" value="<?php echo e(old('longitude', $instansi->longitude ?? '114.590111')); ?>" required
                                        class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 focus:border-red-500 focus:ring-red-500 font-mono text-xs font-bold shadow-xs">
                                </div>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase mb-2 flex items-center justify-between">
                                    ...
                                    <span class="text-xs font-black text-red-700 dark:text-red-300 font-mono bg-red-50 dark:bg-red-950/60 px-2 py-0.5 rounded-md border border-red-200 dark:border-red-800/60" id="radius-display"><?php echo e(old('radius_absen', $instansi->radius_absen ?? 100)); ?> Meter</span>
                                </label>
                                <div class="relative flex items-center gap-3 pt-1">
                                    <input type="range" id="input_radius_slider" min="10" max="2000" step="10" value="<?php echo e(old('radius_absen', $instansi->radius_absen ?? 100)); ?>"
                                        class="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer accent-red-600">
                                    <input type="number" id="input_radius" name="radius_absen" min="10" max="10000" value="<?php echo e(old('radius_absen', $instansi->radius_absen ?? 100)); ?>" required
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div class="lg:col-span-7 bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <form action="<?php echo e(route('dinas.pejabat.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="jabatan_pejabat" value="<?php echo e(old('jabatan_pejabat', $instansi->jabatan_pejabat)); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="nama_pejabat" value="<?php echo e(old('nama_pejabat', $instansi->nama_pejabat)); ?>"
                                            class="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 focus:border-teal-500 focus:ring-teal-500 text-xs font-bold shadow-xs"
                                            placeholder="Nama Lengkap beserta gelar">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 uppercase mb-2">NIP</label>
                                        <input type="text" name="nip_pejabat" value="<?php echo e(old('nip_pejabat', $instansi->nip_pejabat)); ?>"
                                ...
                                <div>
                                    ...
                                    <div class="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-2xl bg-gray-50 dark:bg-gray-900 h-36 flex items-center justify-center mb-3 relative overflow-hidden group">
                                        <img id="preview-ttd" src="<?php echo e($instansi->ttd_kepala ? asset('storage/' . $instansi->ttd_kepala) : ''); ?>" class="h-24 object-contain z-10 <?php echo e($instansi->ttd_kepala ? '' : 'hidden'); ?>">
                                        
                                        <div id="no-ttd-text" class="text-center text-gray-400 dark:text-gray-500 <?php echo e($instansi->ttd_kepala ? 'hidden' : ''); ?>">
                                            <i class="fas fa-image text-2xl mb-1"></i>
                                            <p class="text-xs font-semibold">Belum ada tanda tangan</p>
                                        </div>

                                        <div id="ttd-hover-text" class="absolute inset-0 bg-white/90 dark:bg-gray-800/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 z-20 <?php echo e($instansi->ttd_kepala ? '' : 'hidden'); ?>">
                    ...
                    <div class="p-6 sm:p-8">
                        <div class="bg-gray-50 dark:bg-gray-900 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-700 text-left shadow-inner space-y-2">
                            <div>
                                ...
                                <p class="text-base font-bold text-gray-800 dark:text-gray-100 mt-0.5"><?php echo e($instansi->jabatan_pejabat ?? '[Jabatan Kosong]'); ?></p>
                            </div>
                            
                            <div class="h-32 sm:h-36 flex items-center justify-start my-3 relative">
                                <img id="doc-preview-ttd" src="<?php echo e($instansi->ttd_kepala ? asset('storage/' . $instansi->ttd_kepala) : ''); ?>" class="h-28 sm:h-32 object-contain <?php echo e($instansi->ttd_kepala ? '' : 'hidden'); ?>">
                                <div id="doc-no-ttd" class="w-full h-full border-2 border-dashed border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800/60 flex items-center justify-center text-sm text-gray-400 dark:text-gray-500 italic rounded-2xl <?php echo e($instansi->ttd_kepala ? 'hidden' : ''); ?>">
                                    Area Tanda Tangan
                                </div>
                            </div>
                            ...
                            <div>
                                <p class="text-base font-bold text-gray-900 dark:text-gray-100 border-b-2 border-gray-900 dark:border-gray-200 inline-block pb-0.5 mb-1">
                                    <?php echo e($instansi->nama_pejabat ?? '[Nama Pejabat Kosong]'); ?>

                                </p>
                                <p class="text-xs text-gray-600 dark:text-gray-400 font-semibold">NIP. <?php echo e($instansi->nip_pejabat ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH C:\EnvKit\projects\aplikasi-magang\aplikasi-magang\resources\views\admin_instansi\settings.blade.php ENDPATH**/ ?>