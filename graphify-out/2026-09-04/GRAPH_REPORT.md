# Graph Report - aplikasi-magang - Copy-backup  (2026-09-04)

## Corpus Check
- 865 files · ~525,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3133 nodes · 5250 edges · 733 communities (633 shown, 100 thin omitted)
...
- TrimStrings
- ValidateSignature
- AttendanceFraudStatus.php
- VerifyCsrfToken
- AuthServiceProvider
- StoreCertificateRequest
- SessionConsistencyRule
- GeoDistanceService
- TimestampRule
- Authenticate
- makeSquareIcon
- RequestDatabaseBackupRequest
...
- AttendanceFraudDetector.php
- NetworkAnomalyRule
- RoleBoundaryTest
- Handler
- UpdateSystemSettingsRequest
- AttendanceFraudDecisionTest
- .buildDashboardData
- QrScannerTest

## God Nodes (most connected - your core abstractions)
1. `User` - 332 edges
2. `Application` - 262 edges
3. `Instansi` - 172 edges
4. `InternshipPosition` - 137 edges
5. `TestCase` - 115 edges
6. `Attendance` - 96 edges
7. `Controller` - 72 edges
8. `DailyLog` - 58 edges
9. `MajorCategory` - 42 edges
10. `ApplicationStateTransitionService` - 38 edges
...
## Communities (733 total, 100 thin omitted)

### Community 0 - "User"
Cohesion: 0.03
Nodes (12): User, InstansiPolicy, InternshipPositionPolicy, Illuminate\Foundation\Auth\User, MajorManagementTest, EmailVerificationExemptionTest, EmailVerificationTest, MediumPriorityReviewTest (+4 more)
...
Cohesion: 0.04
Nodes (13): Illuminate\Auth\Notifications\ResetPassword, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\WithFaker, Illuminate\Support\Facades\Notification, ApplicationTest, AttendanceDynamicQrTest, AuthenticationTest, PasswordConfirmationTest (+5 more)

### Community 4 - "Instansi"
Cohesion: 0.04
Nodes (11): InstansiController, LowonganController, Instansi, InternshipPosition, HighPriorityReviewTest, IdCardVerificationTest, MultiRoleHighPriorityIntegrationTest, NotificationTest (+3 more)
...
Cohesion: 0.15
Nodes (4): FraudSignal, AttendanceFraudRule, BoundaryConfidenceRule, RequestFrequencyRule

### Community 7 - "Client"
Cohesion: 0.06
Nodes (18): Client, EnvKitDebugServiceProvider, AppServiceProvider, BroadcastServiceProvider, EventServiceProvider, Illuminate\Auth\Events\Registered, Illuminate\Auth\Listeners\SendEmailVerificationNotification, Illuminate\Auth\Notifications\VerifyEmail (+10 more)
...
Cohesion: 0.15
Nodes (3): AttendanceAttempt, AttendanceAttemptPolicy, AttendanceAttemptService

### Community 10 - "Illuminate\Http\Request"
Cohesion: 0.06
Nodes (8): SettingController, AuditLogController, ReportController, AdminUserController, KioskPresensiController, ReportService, Illuminate\Contracts\Http\Kernel, Illuminate\Http\Request

### Community 11 - "TestCase"
Cohesion: 0.09
Nodes (14): CreatesApplication, RoleAndPermissionSeeder, Illuminate\Foundation\Inspiring, Illuminate\Foundation\Testing\DatabaseTransactions, Illuminate\Foundation\Testing\TestCase, Illuminate\Http\UploadedFile, Illuminate\Support\Facades\Artisan, Illuminate\Support\Facades\Gate (+6 more)
...
Cohesion: 0.06
Nodes (7): GenerateCertificateNumberAction, DashboardController, ApplicationLifecycleService, ApplicationStateTransitionService, CertificateService, InternshipApplicationService, ApplicationStatus

### Community 17 - "DynamicQrService"
Cohesion: 0.07
Nodes (8): AttendanceChallengeService, AttendanceIdempotencyService, AttendanceLockService, DynamicQrService, Illuminate\Cache\Lock, Illuminate\Contracts\Auth\Authenticatable, SimpleSoftwareIO\QrCode\Facades\QrCode, DynamicQrServiceTest
...
Cohesion: 0.10
Nodes (4): CertificateController, NotificationController, TrackingController, Illuminate\Support\Facades\Route

### Community 21 - "AttendanceFraudResult"
Cohesion: 0.20
Nodes (3): AttendanceFraudResult, self, AttendanceFraudStatus
...
Cohesion: 0.09
Nodes (8): LowonganController, MajorCategoryController, MajorController, ProfileController, Major, MajorCategory, MajorSeeder, Illuminate\Validation\Rule

### Community 25 - "DatabaseBackup"
Cohesion: 0.16
Nodes (3): AdminSettingController, DatabaseBackup, DatabaseBackupTest

### Community 26 - "AttendanceController"
Cohesion: 0.22
...
Cohesion: 0.23
Nodes (8): CreateDatabaseBackup, ApplicationStatusNotification, Illuminate\Bus\Queueable, Illuminate\Contracts\Queue\ShouldQueue, Illuminate\Foundation\Bus\Dispatchable, Illuminate\Notifications\Notification, Illuminate\Queue\InteractsWithQueue, Illuminate\Queue\SerializesModels

### Community 40 - "RouteServiceProvider"
Cohesion: 0.18
Nodes (6): RouteServiceProvider, Illuminate\Auth\Events\Verified, Illuminate\Cache\RateLimiting\Limit, Illuminate\Foundation\Support\Providers\RouteServiceProvider, Illuminate\Support\Facades\RateLimiter, Illuminate\Support\Facades\URL

### Community 42 - "PembimbingLapanganController"
Cohesion: 0.11
Nodes (3): ActiveInternController, PembimbingLapanganController, ValidateDailyLogRequest
...
Cohesion: 0.21
Nodes (5): CompleteExpiredInternships, MigratePublicDocumentsToPrivate, PruneExpiredBackups, SendEndingNotifications, Illuminate\Console\Command
...
### Community 55 - "AttendanceFraudContext"
Cohesion: 0.23
Nodes (3): AttendanceFraudContext, ImpossibleTravelRule, Illuminate\Support\Collection
...
### Community 64 - "CancellationPolicyException"
Cohesion: 0.38
...
### Community 84 - "AttendanceService"
Cohesion: 0.22
Nodes (4): AttendanceService, Carbon, PembimbingLogbookService, Illuminate\Database\Eloquent\Builder
...
### Community 121 - "AttendanceFraudStatus.php"
Cohesion: 0.22
Nodes (3): fromScore(), self, AttendanceRiskScorer
...
Cohesion: 0.14
Nodes (5): PermissionRequest, AssignMentorRequest, UpdateDailyLogRequest, ProfileUpdateRequest, Illuminate\Foundation\Http\FormRequest
...
Cohesion: 0.07
Nodes (6): DailyLog, DailyLogPolicy, DatabaseSeeder, AllPdfReportsRenderingTest, LogbookIntegrityTest, DailyLogAuthorizationTest
...
### Community 678 - "AuditLogService"
Cohesion: 0.10
Nodes (14): AuditLogService, Barryvdh\DomPDF\Facade\Pdf, Carbon\Carbon, Illuminate\Auth\Events\Lockout, Illuminate\Database\QueryException, Illuminate\Support\Facades\Auth, Illuminate\Support\Facades\Cache, Illuminate\Support\Facades\DB (+6 more)
...
- **Why does `User` connect `User` to `User.php`, `Illuminate\Foundation\Testing\RefreshDatabase`, `ReportController`, `Instansi`, `Controller`, `AttendanceAttempt`, `Illuminate\Http\Request`, `TestCase`, `Application`, `AttendanceDispute`, `CertificateController`, `ClockInOutAntiFraudTest`, `Illuminate\Foundation\Http\FormRequest`, `MajorCategory`, `DatabaseBackup`, `Illuminate\Database\Eloquent\Model`, `FullSystemRoleAndPageVerificationTest`, `University`, `DailyLog`, `AuditLogService`, `RouteServiceProvider`, `PembimbingLapanganViewsTest`, `PesertaViewRegressionTest`, `Setting`, `PembimbingLapanganController`, `EmailViewsTest`, `AttendanceChallengeTest`, `PdfExportService`, `AttendanceFraudContext`, `Attendance`, `LaporanRedesignSmokeTest`, `AttendanceDisputeService`, `AttendanceRegressionTest`, `CertificateGovernanceTest`, `AttendanceFraudMonitoringTest`, `AttendanceAuthorizationTest`, `PembimbingSekolahController`, `PembimbingSekolahViewsTest.php`, `FraudMonitoringController`, `RoleBoundaryTest`, `.buildDashboardData`, `ApplicationAuthorizationTest`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `Application` connect `Application` to `User`, `Illuminate\Foundation\Testing\RefreshDatabase`, `ReportController`, `Instansi`, `Illuminate\Http\Request`, `TestCase`, `ApplicationAcceptedMail`, `AttendanceDispute`, `ApplicationStateTransitionService`, `LogbookController`, `CertificateController`, `Illuminate\Database\Seeder`, `MajorCategory`, `AttendanceController`, `Illuminate\Database\Eloquent\Model`, `FullSystemRoleAndPageVerificationTest`, `DailyLog`, `ApplicantController`, `Symfony\Component\HttpFoundation\Response`, `AuditLogService`, `CreateDatabaseBackup.php`, `PembimbingLapanganViewsTest`, `PembimbingLapanganController`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `PesertaViewRegressionTest`, `EmailViewsTest`, `AttendanceChallengeTest`, `Illuminate\Console\Command`, `PdfExportService`, `AttendanceFraudContext`, `Attendance`, `CertificateGovernanceTest`, `StorageAccessController`, `PembimbingSekolahController`, `PembimbingSekolahViewsTest.php`, `AttendanceService`, `.buildDashboardData`, `ApplicationAuthorizationTest`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Instansi` connect `Instansi` to `User`, `Illuminate\Foundation\Testing\RefreshDatabase`, `Controller`, `ApplicationFactory`, `Illuminate\Http\Request`, `TestCase`, `Application`, `AttendanceDispute`, `DynamicQrService`, `Illuminate\Database\Seeder`, `MajorCategory`, `AttendanceController`, `Illuminate\Database\Eloquent\Model`, `FullSystemRoleAndPageVerificationTest`, `DailyLog`, `AuditLogService`, `PembimbingLapanganViewsTest`, `PesertaViewRegressionTest`, `EmailViewsTest`, `AttendanceChallengeTest`, `PdfExportService`, `AttendanceFraudContext`, `AttendanceRegressionTest`, `CertificateGovernanceTest`, `AttendanceFraudMonitoringTest`, `AttendanceAuthorizationTest`, `Certificate`, `PembimbingSekolahViewsTest.php`, `RoleBoundaryTest`, `ApplicationAuthorizationTest`?**
...
- **Should `User` be split into smaller, more focused modules?**
  _Cohesion score 0.03197980223017042 - nodes in this community are weakly interconnected._
