    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="space-y-1.5">
                ...
                <input id="name" name="name" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('name', $user->name) }}" required autofocus autocomplete="name" />
            ...
            <div class="space-y-1.5">
                ...
                <input id="username" name="username" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('username', $user->username) }}" required autocomplete="username" placeholder="username_anda" />
            ...
            <div class="space-y-1.5 md:col-span-2">
                ...
                <input id="email" name="email" type="email" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('email', $user->email) }}" required autocomplete="username" />
        ...
        <div class="border-t border-gray-100 dark:border-gray-700 pt-5 mt-5">
            ...
            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-900/80 border border-gray-200 dark:border-gray-700/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div class="flex-1 space-y-1">
                    ...
                    <input id="signature" name="signature" type="file" class="block w-full text-xs text-gray-500 dark:text-gray-400 file:mr-4 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100" accept="image/*" />
                    <x-input-error class="mt-1" :messages="$errors->get('signature')" />
                </div>
                @if ($user->signature)
                <div class="shrink-0 text-center bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-gray-700 shadow-2xs">
        ...
        <div class="border-t border-gray-100 dark:border-gray-700 pt-5 mt-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="nik" name="nik" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('nik', $user->nik) }}" placeholder="Nomor Induk Dosen / Pegawai" />
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="phone" name="phone" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('phone', $user->phone) }}" placeholder="Contoh: 0812xxxx" />
                ...
                <div class="space-y-1.5 md:col-span-2">
                    ...
                    <input id="asal_instansi" name="asal_instansi" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('asal_instansi', $user->asal_instansi) }}" placeholder="Contoh: Universitas Lambung Mangkurat" required />
        ...
        <div class="border-t border-gray-100 dark:border-gray-700 pt-5 mt-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="nik" name="nik" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('nik', $user->nik) }}" placeholder="Nomor Induk Mahasiswa" />
                ...
                <div class="space-y-1.5">
                    ...
                    <input id="major" name="major" type="text" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs transition-all outline-none focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15" value="{{ old('major', $user->major) }}" placeholder="Contoh: Teknik Informatika" required />
                ...
                <div class="md:col-span-2 mt-2 p-5 bg-teal-50/60 rounded-xl border border-teal-100">
                    ...
                    @if(isset($pembimbings) && count($pembimbings) > 0)
                        <select id="pembimbing_sekolah_id" name="pembimbing_sekolah_id" class="w-full min-w-0 rounded-lg border border-teal-300 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 shadow-2xs focus:border-teal-600 focus:ring-3 focus:ring-teal-600/15">
                    ...
                    @else
                        <select id="pembimbing_sekolah_id" name="pembimbing_sekolah_id" class="w-full min-w-0 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 px-3 py-2 text-sm text-gray-500 dark:text-gray-400 shadow-2xs" disabled>
