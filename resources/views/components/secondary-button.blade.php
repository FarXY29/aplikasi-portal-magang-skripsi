<button x-data="{ loading: false }" 
        ...
        :disabled="loading"
        {{ $attributes->merge(['type' => 'button', 'class' => 'inline-flex items-center justify-center px-4 py-2.5 bg-white dark:bg-gray-800 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-xl font-bold text-xs text-gray-700 dark:text-gray-300 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-900 dark:hover:bg-gray-700 hover:border-teal-500 hover:text-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-25 transition-all active:scale-95 ease-in-out duration-150 relative overflow-hidden group']) }}>
