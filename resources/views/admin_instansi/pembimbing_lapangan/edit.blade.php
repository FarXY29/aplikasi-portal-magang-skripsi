<x-app-layout>
    ...
    <div class="py-8 bg-gray-50/50 min-h-screen font-sans">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="{{ route('dinas.pembimbing_lapangan.index') }}" class="group inline-flex items-center text-sm font-bold text-gray-500 hover:text-teal-600 transition">
                ...
                <div class="p-8">
                    <form action="{{ route('dinas.pembimbing_lapangan.update', $pembimbing_lapangan->id) }}" method="POST">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100 flex items-center justify-end gap-3">
                            <a href="{{ route('dinas.pembimbing_lapangan.index') }}" class="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-600 font-bold hover:bg-gray-50 transition text-sm">
                                Batal
                            </a>
