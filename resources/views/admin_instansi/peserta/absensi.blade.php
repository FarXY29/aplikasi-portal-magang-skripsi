        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Memantau kehadiran peserta: <span class="font-bold text-gray-800 dark:text-gray-200">{{ $app->user->name }}</span>
                </p>
            </div>
            
            <div class="flex items-center gap-2">
                <a href="{{ route('dinas.peserta.index') }}" class="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-900 transition shadow-sm">
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900/50 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-4 border-b border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between md:items-center gap-4 bg-gray-50 dark:bg-gray-900">
                    <h3 class="font-bold text-gray-700 dark:text-gray-300">Daftar Kehadiran</h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-white dark:bg-gray-800">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Jam Masuk</th>
                                <th class="px-6 py-3 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Jam Pulang</th>
                                <th class="px-6 py-3 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Status</th>
                                <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Catatan / Bukti</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    @if($log->clock_in)
                                        <span class="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-sm font-mono font-bold text-gray-700 dark:text-gray-300">
