<x-app-layout>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900/50 min-h-screen font-sans">
        <div class="flex justify-between items-center mb-6 print:hidden max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('dinas.laporan.hub') }}" class="group flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-blue-600 transition">
                <div class="w-8 h-8 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center mr-2 group-hover:border-blue-500 shadow-sm">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-600/20 flex flex-col sm:flex-row items-center gap-4">
                ...
                <div class="sm:ml-auto">
                    <div class="flex gap-2">
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'pdf']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800/20 backdrop-blur-sm text-white rounded-xl hover:bg-white dark:hover:bg-gray-800/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download PDF">
                                <i class="fas fa-file-pdf text-red-500"></i> PDF
                            </a>
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'excel']) }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800/20 backdrop-blur-sm text-white rounded-xl hover:bg-white dark:hover:bg-gray-800/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download Excel">
                                <i class="fas fa-file-excel text-green-600"></i> Excel
                            </a>
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'csv']) }}" class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800/20 backdrop-blur-sm text-white rounded-xl hover:bg-white dark:hover:bg-gray-800/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download CSV">
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                ...
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nama Mahasiswa & Kampus</th>
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Posisi Magang</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kehadiran</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Validasi Logbook</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nilai Akhir</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-50" x-data="{ openRow: null }">
                            ...
                            <tr class="hover:bg-blue-50/20 dark:hover:bg-blue-900/10 transition cursor-pointer" @click="openRow = openRow === {{ $loop->index }} ? null : {{ $loop->index }}">
                                ...
                                <td class="px-5 py-4 text-xs text-gray-700 dark:text-gray-300 font-bold">
                                ...
                                <td class="px-5 py-4 text-center">
                                    @if($app->avg_nilai > 0)
                                        <span class="text-sm font-black text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-800 px-2.5 py-0.5 rounded-full inline-block">
                                        ...
                                        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 shadow-sm space-y-3">
                                            ...
                                            @else
                                                <div class="text-xs text-gray-500 dark:text-gray-400 py-2">
                                                    <p class="font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1"><i class="fas fa-info-circle text-blue-500"></i> Magang Belum Selesai</p>
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="font-bold text-gray-500 dark:text-gray-400">Belum ada data Mahasiswa</p>
