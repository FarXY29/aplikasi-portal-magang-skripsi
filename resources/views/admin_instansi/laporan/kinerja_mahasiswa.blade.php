            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-650 rounded-2xl p-6 text-white shadow-lg shadow-blue-600/20 flex flex-col sm:flex-row items-center gap-4">
                ...
                <div class="sm:ml-auto">
                    <div class="flex gap-2">
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'pdf']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download PDF">
                                <i class="fas fa-file-pdf text-red-500"></i> PDF
                            </a>
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'excel']) }}" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download Excel">
                                <i class="fas fa-file-excel text-green-600"></i> Excel
                            </a>
                            <a href="{{ route('dinas.laporan.kinerja_mahasiswa.print', ['format' => 'csv']) }}" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download CSV">
