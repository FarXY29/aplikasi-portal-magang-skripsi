<x-app-layout>
    ...
    <div class="py-8 bg-gray-50/50 min-h-screen font-sans">
        <div class="flex justify-between items-center mb-6 print:hidden">
            <a href="{{ route('dinas.laporan.hub') }}" class="group flex items-center text-sm font-bold text-gray-500 hover:text-orange-600 transition">
                <div class="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center mr-2 group-hover:border-orange-500 shadow-sm">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-2xl font-black text-gray-800">{{ $stats['total_kampus'] }}</p>
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Asal Kampus</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-2xl font-black text-gray-800">{{ $stats['total_jurusan'] }}</p>
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Jurusan</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-2xl font-black text-gray-800">{{ $stats['total_pelamar'] }}</p>
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Total Pelamar</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Diterima</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Lulus / Selesai</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Ditolak</p>
                </div>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 text-center">
                    ...
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-1">Pending</p>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl p-6 text-white shadow-lg shadow-orange-500/20 flex flex-col sm:flex-row items-center gap-4">
                ...
                <div class="sm:ml-auto">
                    <div class="flex gap-2">
                            <a href="{{ route('dinas.laporan.demografi_kampus.print', ['format' => 'pdf']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download PDF">
                                <i class="fas fa-file-pdf text-red-500"></i> PDF
                            </a>
                            <a href="{{ route('dinas.laporan.demografi_kampus.print', ['format' => 'excel']) }}" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download Excel">
                                <i class="fas fa-file-excel text-green-600"></i> Excel
                            </a>
                            <a href="{{ route('dinas.laporan.demografi_kampus.print', ['format' => 'csv']) }}" class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition text-sm font-bold shadow-md border border-white/30 gap-1.5" title="Download CSV">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Klik baris kampus untuk melihat detail jurusan, posisi, dan daftar peserta yang diterima.</p>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Asal Kampus / Sekolah</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Pelamar</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Diterima</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Selesai</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Ditolak</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Pending</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Rasio</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-50" x-data="{ openRow: null }">
                            ...
                            <tr class="hover:bg-orange-50/50 transition cursor-pointer" @click="openRow = openRow === {{ $loop->index }} ? null : {{ $loop->index }}">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-bold text-gray-900">{{ $kampus }}</p>
                                            <p class="text-[10px] text-gray-400 font-medium">{{ $data['jurusan']->count() }} jurusan</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-5 py-4 text-center"><span class="text-sm font-black text-gray-800">{{ $data['total_pelamar'] }}</span></td>
                            ...
                            <tr x-show="openRow === {{ $loop->index }}" x-transition.opacity x-cloak>
                                <td colspan="9" class="px-5 py-0 bg-gray-50/50">
                                    <div class="py-5 grid grid-cols-1 lg:grid-cols-3 gap-5">
                                        {{-- Jurusan Breakdown --}}
                                        <div class="bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                                            <p class="text-[10px] font-black text-gray-500 uppercase tracking-wider mb-3"><i class="fas fa-graduation-cap mr-1 text-purple-500"></i> Jurusan</p>
                                            <div class="space-y-2">
                                                @foreach($data['jurusan'] as $jurusan => $count)
                                                <div class="flex items-center justify-between">
                                                    <span class="text-xs text-gray-700 font-medium truncate mr-2">{{ $jurusan }}</span>
                                        ...
                                        {{-- Posisi Breakdown --}}
                                        <div class="bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                                            <p class="text-[10px] font-black text-gray-500 uppercase tracking-wider mb-3"><i class="fas fa-briefcase mr-1 text-blue-500"></i> Posisi Diminati</p>
                                            <div class="space-y-2">
                                                @foreach($data['posisi'] as $posisi => $count)
                                                <div class="flex items-center justify-between">
                                                    <span class="text-xs text-gray-700 font-medium truncate mr-2">{{ $posisi }}</span>
                                        ...
                                        {{-- Peserta Diterima --}}
                                        <div class="bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                                            <p class="text-[10px] font-black text-gray-500 uppercase tracking-wider mb-3"><i class="fas fa-user-check mr-1 text-green-500"></i> Peserta Diterima ({{ $data['peserta_aktif']->count() }})</p>
                                            ...
                                            <div class="space-y-2 max-h-48 overflow-y-auto custom-scrollbar">
                                                ...
                                                <div class="flex items-start gap-2 p-2 bg-green-50/50 rounded-lg border border-green-100/50">
                                                    ...
                                                    <div class="min-w-0">
                                                        <p class="text-xs font-bold text-gray-800 truncate">{{ $peserta['nama'] }}</p>
                                                        <p class="text-[10px] text-gray-500">{{ $peserta['posisi'] }}</p>
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center text-gray-400">
                                        ...
                                        <p class="font-bold text-gray-500">Belum ada data pendaftaran magang</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Menampilkan jurusan atau program studi mana yang paling banyak mendaftar dan diterima.</p>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider w-12">No</th>
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Jurusan / Program Studi</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Total Pelamar</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Diterima</th>
                                <th class="px-5 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Rasio Penerimaan</th>
                                <th class="px-5 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Visualisasi</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="hover:bg-purple-50/30 transition">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-sm font-bold text-gray-800">{{ $jurusan }}</span>
                                    </div>
                                </td>
                                <td class="px-5 py-4 text-center"><span class="text-sm font-black text-gray-800">{{ $data['total'] }}</span></td>
                                <td class="px-5 py-4 text-center"><span class="text-sm font-bold text-green-600">{{ $data['diterima'] }}</span></td>
                                <td class="px-5 py-4 text-center">
                                    @php
                                        $rate = $data['acceptance_rate'];
