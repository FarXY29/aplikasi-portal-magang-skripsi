                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <div class="bg-gray-50 p-3 rounded-lg flex justify-between">
                                    ...
                                    <span class="font-bold text-gray-800">{{ $app->nilai_kerajinan }}</span>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg flex justify-between">
                                    <span class="text-gray-600">Disiplin</span>
                                    <span class="font-bold text-gray-800">{{ $app->nilai_disiplin }}</span>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg flex justify-between">
                                    <span class="text-gray-600">Adaptasi</span>
                                    <span class="font-bold text-gray-800">{{ $app->nilai_adaptasi }}</span>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg flex justify-between">
                                    <span class="text-gray-600">Kreatifitas</span>
                                    <span class="font-bold text-gray-800">{{ $app->nilai_kreatifitas }}</span>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg flex justify-between">
                                    <span class="text-gray-600">Skill dan Pengetahuan</span>
                                    <span class="font-bold text-gray-800">{{ $app->nilai_skill_pengetahuan }}</span>
                                </div>
                            </div>
