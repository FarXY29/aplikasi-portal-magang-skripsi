<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-black text-xl text-slate-100 leading-tight">Dashboard Admin Instansi</h2>
                <p class="text-xs text-slate-400 font-medium hidden md:block">Pusat Pengelolaan & Monitoring Magang — {{ $instansi->nama_dinas }}</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="space-y-5 md:space-y-6 font-[Inter] py-2 bg-[#0f172a] text-slate-100 min-h-screen">
        ...
        @if(!empty($globalAnnouncement))
            <div class="bg-[#161f33] border-l-4 border-amber-500 p-5 rounded-2xl shadow-lg border border-slate-800/40 flex gap-4 items-start relative overflow-hidden">
                ...
                <div class="flex-1">
                    <h4 class="text-xs font-black text-amber-400 uppercase tracking-wider mb-1">Pengumuman Kota Banjarmasin</h4>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
            {{-- Card 1: Lowongan --}}
            <a href="{{ route('dinas.lowongan.index') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-teal-500/40 hover:shadow-teal-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-[10px] md:text-xs font-black uppercase tracking-wider text-slate-400">LOWONG...</p>
                        <h3 id="stat-lowongan" class="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-white">{{ number_format($totalLowongan) }}</h3>
                        <p class="mt-1 text-[10px] md:text-xs font-semibold text-slate-400">Posisi magang</p>
                    </div>
            ...
            {{-- Card 2: Pembimbing --}}
            <a href="{{ route('dinas.pembimbing_lapangan.index') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/40 hover:shadow-blue-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                        <p class="text-[10px] md:text-xs font-black uppercase tracking-wider text-slate-400">PEMBIMBI...</p>
                        <h3 id="stat-pembimbing" class="mt-2 text-2xl md:text-3xl font-extrabold tracking-tight text-white">{{ number_format($totalPembimbing) }}</h3>
                        <p class="mt-1 text-[10px] md:text-xs font-semibold text-slate-400">Pembimbing lapangan</p>
                    </div>
            ...
            {{-- Card 3: Pendaftar --}}
            <a href="{{ route('dinas.pelamar') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/40 hover:shadow-purple-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
            ...
            {{-- Card 4: Aktif --}}
            <a href="{{ route('dinas.peserta.index') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/40 hover:shadow-emerald-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
            ...
            {{-- Card 5: Selesai --}}
            <a href="{{ route('dinas.peserta.index') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-indigo-500/40 hover:shadow-indigo-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
            ...
            {{-- Card 6: Pending --}}
            <a href="{{ route('dinas.pelamar') }}" class="group block relative overflow-hidden rounded-2xl md:rounded-3xl border border-slate-800/40 bg-[#161f33] p-4 md:p-5 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/40 hover:shadow-amber-500/10">
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-base font-black text-white">Tren Pendaftaran Magang</h3>
                                <p class="text-xs text-slate-400 font-medium">Jumlah pendaftar per hari ke {{ $instansi->nama_dinas }}</p>
                            </div>
                        </div>
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400 font-medium">Distribusi status pelamar di instansi ini</p>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
            ...
            <div class="bg-[#161f33] rounded-3xl border border-slate-800/40 p-6 shadow-xl flex flex-col justify-between">
                <div class="mb-4 pb-4 border-b border-slate-800/60 flex items-center justify-between">
                    <div>
                        <h3 class="text-base font-black text-white">Demografi Asal Peserta</h3>
                        <p class="text-xs text-slate-400 mt-0.5">Sekolah / Perguruan Tinggi pengirim terbanyak</p>
                    </div>
                ...
                <div class="space-y-4">
                    @if(count($topInstansi) > 0)
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="w-8 h-8 rounded-xl bg-slate-900 flex items-center justify-center text-slate-400 font-bold text-xs border border-slate-800 shrink-0">
                                    {{ $index + 1 }}
                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-bold text-slate-200 truncate cursor-help hover:text-teal-400 transition" 
                                       title="{{ $inst->asal_instansi }}">
                                        {{ $inst->asal_instansi }}
                                    </p>
                                    <div class="w-full bg-slate-900 rounded-full h-1.5 mt-1.5 overflow-hidden border border-slate-800">
                                        <div class="bg-teal-400 h-1.5 rounded-full" style="width: {{ min(($inst->total_peserta / $topInstansi[0]->total_peserta) * 100, 100) }}%"></div>
                                    </div>
                                </div>
                            </div>
                            <span class="text-xs font-black text-teal-300 bg-teal-500/10 px-2.5 py-1 rounded-xl border border-teal-500/30 shrink-0 ml-3">
                    ...
                    @else
                        <div class="text-center py-8 text-slate-400">
                            <i class="fas fa-university text-2xl text-slate-600 mb-2 block"></i>
            ...
            <div class="bg-[#161f33] rounded-3xl border border-slate-800/40 p-6 shadow-xl">
                <div class="flex items-center justify-between mb-4 pb-4 border-b border-slate-800/60">
                    <div>
                        <h3 class="text-base font-black text-white">Posisi Magang Lowongan</h3>
                        <p class="text-xs text-slate-400 mt-0.5">Daftar posisi magang aktif di instansi ini</p>
                    </div>
                    <a href="{{ route('dinas.lowongan.index') }}" class="text-[10px] text-teal-400 bg-teal-500/10 px-2.5 py-1 rounded-lg font-black transition border border-teal-500/30">Kelola</a>
                </div>
                ...
                <div class="divide-y divide-slate-800/60">
                    ...
                    @empty
                    <div class="text-center py-8 text-slate-400">
                        <i class="fas fa-briefcase text-2xl text-slate-600 mb-2 block"></i>
