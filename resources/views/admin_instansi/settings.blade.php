<x-app-layout>
    ...
    <div class="py-8 bg-gray-50/50 min-h-screen font-sans">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-50 bg-gray-50/50 flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-800">Lokasi Kantor & Radius Absensi</h3>
                            <p class="text-xs text-gray-500">Tentukan titik koordinat kantor dan batas radius toleransi absensi (Geofencing).</p>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    <form action="{{ route('dinas.settings.update') }}" method="POST">
                        ...
                        <!-- Peta Leaflet -->
                        <div class="mb-6">
                            <label class="block text-sm font-bold text-gray-700 mb-2 flex items-center justify-between flex-wrap gap-2">
                                <span>Peta Titik Kantor Instansi</span>
                                <span class="text-xs font-normal text-gray-500"><i class="fas fa-info-circle text-teal-600 mr-1"></i> Klik atau geser penanda (marker) pada peta untuk mengubah koordinat</span>
                            </label>
                            <div id="map-instansi" class="w-full h-80 sm:h-96 rounded-2xl border-2 border-gray-200 shadow-inner z-10 relative"></div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Latitude (Garis Lintang)</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                        <i class="fas fa-globe"></i>
                                    </span>
                                    <input type="number" step="any" id="input_latitude" name="latitude" value="{{ old('latitude', $instansi->latitude ?? '-3.316694') }}" required
                                        class="w-full pl-10 pr-4 py-2.5 rounded-xl border-gray-300 focus:border-red-500 focus:ring focus:ring-red-200 transition shadow-sm font-mono text-sm font-bold">
                                </div>
                                <p class="text-[11px] text-gray-400 mt-1">Koordinat Lintang Kantor</p>
                            </div>

                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Longitude (Garis Bujur)</label>
                                <div class="relative">
                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                        <i class="fas fa-globe"></i>
                                    </span>
                            ...
                            <div>
                                ...
                                <div class="relative flex items-center gap-3 pt-1">
                                    ...
                                    <input type="number" id="input_radius" name="radius_absen" min="10" max="10000" value="{{ old('radius_absen', $instansi->radius_absen ?? 100) }}" required
                                        class="w-24 px-3 py-1.5 rounded-xl border-gray-300 focus:border-red-500 focus:ring focus:ring-red-200 transition shadow-sm font-mono text-sm text-center font-bold">
                                </div>
            ...
            <div class="bg-gray-100 rounded-2xl p-8 border border-dashed border-gray-300 text-center">
                ...
                <div class="inline-block bg-white p-8 shadow-lg max-w-sm w-full mx-auto relative rotate-1 hover:rotate-0 transition duration-500 transform">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-xs text-gray-600">NIP. {{ $instansi->nip_pejabat ?? '-' }}</p>
                    </div>
                </div>
            </div>
