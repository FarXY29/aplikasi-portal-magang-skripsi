                ...
                <div class="w-full lg:w-3/4 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-teal-600 to-indigo-600 rounded-2xl p-6 text-white shadow-lg shadow-teal-600/20 flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <div class="sm:ml-auto flex-shrink-0">
                            <a href="{{ route('dinas.laporan.rekap.print', request()->query()) }}" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-white text-teal-700 rounded-xl hover:bg-teal-50 transition text-sm font-bold shadow-md border border-white/20">
