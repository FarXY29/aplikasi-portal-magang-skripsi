        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if($logs->isEmpty())
                <div class="flex flex-col items-center justify-center py-16 bg-white rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Belum ada aktivitas logbook pada periode yang dipilih.</p>
                </div>
            @else
                                    ...
                                    <li>
                                        <button @click="activeTab = {{ $log->id }}"
                                            ...
                                            <div class="flex justify-between items-start mb-1">
                                                <span class="text-sm font-bold text-gray-800" :class="{ 'text-teal-700': activeTab === {{ $log->id }} }">
