    ...
    <div class="py-8 bg-gray-50/50 min-h-screen font-sans">
        <div class="flex justify-between items-center mb-6 print:hidden">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.laporan.penyerapan_kuota.print', ['format' => 'pdf']) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download PDF">
                        <i class="fas fa-file-pdf text-red-500"></i> <span class="hidden sm:inline">PDF</span>
                    </a>
                    <a href="{{ route('admin.laporan.penyerapan_kuota.print', ['format' => 'excel']) }}" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download Excel">
                        <i class="fas fa-file-excel text-green-600"></i> <span class="hidden sm:inline">Excel</span>
                    </a>
                    <a href="{{ route('admin.laporan.penyerapan_kuota.print', ['format' => 'csv']) }}" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download CSV">
