    ...
    <div class="py-8 bg-gray-50/50 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center print:hidden">
                <a href="{{ route('admin.laporan.hub') }}" class="group flex items-center text-sm font-bold text-gray-500 hover:text-teal-650 transition">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.laporan.grading.print', array_merge(request()->query(), ['format' => 'pdf'])) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download PDF">
                        <i class="fas fa-file-pdf text-red-500"></i> <span class="hidden sm:inline">PDF</span>
                    </a>
                    <a href="{{ route('admin.laporan.grading.print', array_merge(request()->query(), ['format' => 'excel'])) }}" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download Excel">
                        <i class="fas fa-file-excel text-green-600"></i> <span class="hidden sm:inline">Excel</span>
                    </a>
                    <a href="{{ route('admin.laporan.grading.print', array_merge(request()->query(), ['format' => 'csv'])) }}" class="inline-flex items-center px-4 py-2 bg-white text-teal-700 border border-gray-200 hover:bg-teal-50 rounded-xl font-bold text-xs transition shadow-sm gap-2" title="Download CSV">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 text-center bg-gradient-to-br from-teal-50/50 to-indigo-50/30">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-black text-gray-800">{{ $statsGlobal['avg_teknis'] }}/100</span>
                    </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-black text-gray-800">{{ $statsGlobal['avg_disiplin'] }}/100</span>
                    </div>
                    <div class="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-black text-gray-800">{{ $statsGlobal['avg_perilaku'] }}/100</span>
                    </div>
                    <div class="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                <div class="text-center mb-6">
                    <h3 class="text-lg font-black text-gray-800 flex items-center justify-center gap-2">
                        <i class="fas fa-trophy text-yellow-500 animate-bounce"></i> TOP 3 PERFORMER TERBAIK KOTA
                    </h3>
                    <p class="text-xs text-gray-500 mt-1">Apresiasi khusus untuk peserta magang dengan pencapaian performa tertinggi se-Kota Banjarmasin.</p>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-end justify-center gap-6 md:gap-4 max-w-4xl mx-auto pt-6">
                    ...
                    <div class="w-full md:w-1/3 order-2 md:order-1 flex flex-col items-center">
                        <div class="relative mb-3 flex flex-col items-center">
                            <div class="h-16 w-16 rounded-full bg-gradient-to-br from-gray-100 to-gray-300 flex items-center justify-center text-gray-700 font-black border-4 border-white shadow-md text-lg relative">
                        ...
                        <div class="text-center mb-2">
                            <p class="font-bold text-gray-800 text-sm truncate max-w-[180px]">{{ $p2['nama'] }}</p>
                            <p class="text-[10px] text-gray-500 truncate max-w-[180px] font-semibold">{{ $p2['asal_instansi'] }}</p>
                            <p class="text-[9px] text-teal-650 bg-teal-50 px-2 py-0.5 rounded-full inline-block font-bold mt-1">{{ $p2['instansi'] }}</p>
                        </div>
                        <div class="w-full bg-gradient-to-t from-gray-100 to-gray-200/50 rounded-t-2xl pt-8 pb-4 text-center border-t border-gray-200 shadow-sm flex flex-col justify-center items-center h-28">
                            <span class="text-xs font-bold text-gray-500 uppercase tracking-wider">SKOR AKHIR</span>
                            <span class="text-2xl font-black text-gray-700 mt-1">{{ $p2['rata_rata'] }}</span>
                            <span class="text-[9px] font-extrabold text-gray-500 mt-1 uppercase">{{ $p2['predikat'] }}</span>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="w-full md:w-1/3 order-3 md:order-3 flex flex-col items-center">
                        ...
                        <div class="text-center mb-2">
                            <p class="font-bold text-gray-800 text-sm truncate max-w-[180px]">{{ $p3['nama'] }}</p>
                            <p class="text-[10px] text-gray-500 truncate max-w-[180px] font-semibold">{{ $p3['asal_instansi'] }}</p>
            ...
            <div class="bg-gradient-to-r from-teal-700 to-indigo-700 rounded-3xl p-6 text-white shadow-lg shadow-teal-700/20 flex flex-col sm:flex-row items-center gap-4">
                ...
                <div class="sm:ml-auto flex-shrink-0">
                    <a href="{{ route('admin.laporan.grading.print', request()->query()) }}" target="_blank" class="inline-flex items-center px-5 py-2.5 bg-white text-teal-700 rounded-xl hover:bg-teal-50 transition text-sm font-bold shadow-md">
            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start">
                ...
                <div class="w-full lg:w-1/4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 print:hidden lg:sticky lg:top-8">
                    ...
                    <form method="GET" action="{{ route('admin.laporan.grading') }}" class="flex flex-col gap-5">
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1.5">Nama Peserta</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-1.5">Predikat Kelulusan</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400 pointer-events-none">
                                    <i class="fas fa-award text-xs"></i>
                                </span>
                                <select name="predikat" class="w-full pl-9 border-gray-200 rounded-xl text-sm focus:ring-teal-500 focus:border-teal-500 shadow-sm cursor-pointer bg-gray-50 hover:bg-white transition">
                ...
                <div class="w-full lg:w-3/4 space-y-6" x-data="{ openRow: null }">
                    <div class="bg-white shadow-sm sm:rounded-3xl border border-gray-100 overflow-hidden">
                        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <div>
                                <h3 class="font-bold text-gray-800">Daftar Analisis Kompetensi & Performa</h3>
                                <p class="text-xs text-gray-500 mt-1">Daftar peringkat berdasarkan nilai rata-rata akhir peserta terfilter.</p>
                            </div>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-100 border-collapse">
                                ...
                                <tbody class="bg-white divide-y divide-gray-50 text-sm">
                                    ...
                                    <tr class="hover:bg-teal-50/15 transition group cursor-pointer" @click="openRow = (openRow === {{ $index }} ? null : {{ $index }})">
                                        <td class="px-5 py-4 text-center">
                                            ...
                                            @elseif($index == 1 && !request('q') && !request('instansi') && !request('instansi_id') && !request('predikat'))
                                                <div class="w-7 h-7 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center mx-auto border border-gray-300 font-bold text-xs">2</div>
                                        ...
                                        <td class="px-5 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="min-w-0">
                                                    <div class="font-bold text-gray-900 truncate">{{ $res['nama'] }}</div>
                                        ...
                                        <td class="px-5 py-4">
                                            <div class="flex flex-col gap-0.5">
                                                ...
                                                <span class="text-[10px] text-gray-500 font-medium">
                                                    Posisi: <span class="font-semibold text-gray-600">{{ $res['posisi'] }}</span>
                                                </span>
                                            </div>
                                        </td>
                                        <td class="px-5 py-4 text-center">
                                        ...
                                        <td class="px-5 py-4 text-center">
                                            @php
                                                $badgeColor = match($res['predikat']) {
                                                    ...
                                                    default => 'bg-gray-100 text-gray-650 border-gray-200'
                                                };
                                            @endphp
                                    ...
                                    <tr x-show="openRow === {{ $index }}" x-transition.opacity x-cloak>
                                        <td colspan="6" class="px-6 py-4 bg-gray-50/50 border-y border-gray-100">
                                            <div class="bg-white rounded-2xl border border-gray-250/60 p-5 shadow-sm">
                                                ...
                                                @if($res['nilai_rata_rata'] !== null)
                                                    ...
                                                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            ...
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['kerajinan'] }}</div>
                                                        </div>
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            <div class="text-[9px] font-bold text-gray-400 uppercase">Kedisiplinan</div>
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['disiplin'] }}</div>
                                                        </div>
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            <div class="text-[9px] font-bold text-gray-400 uppercase">Adaptasi</div>
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['adaptasi'] }}</div>
                                                        </div>
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            <div class="text-[9px] font-bold text-gray-400 uppercase">Kreatifitas</div>
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['kreatifitas'] }}</div>
                                                        </div>
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150 col-span-2 md:col-span-1">
                                                            <div class="text-[9px] font-bold text-gray-400 uppercase">Skill & Pengetahuan</div>
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['skill'] }}</div>
                                                        </div>
                                                    </div>
                                                ...
                                                @else
                                                    ...
                                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            ...
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['teknis'] }}</div>
                                                        </div>
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            <div class="text-[9px] font-bold text-gray-400 uppercase">Kedisiplinan</div>
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['disiplin'] }}</div>
                                                        ...
                                                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-150">
                                                            ...
                                                            <div class="text-xl font-black text-gray-800 mt-1">{{ $res['perilaku'] }}</div>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3 flex items-center justify-between text-xs text-gray-400 italic">
