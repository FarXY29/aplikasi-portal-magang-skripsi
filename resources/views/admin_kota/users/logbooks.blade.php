    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 w-full">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-black text-xl text-gray-900 leading-tight">Monitoring Logbook</h2>
                    <p class="text-xs text-gray-500 font-medium hidden sm:block">Pantau kegiatan harian dan logbook peserta magang</p>
                </div>
            </div>
        ...
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
            <form method="GET" action="{{ route('admin.users.logbooks') }}" class="relative w-full md:w-96">
                ...
                <input type="text" name="search" value="{{ request('search') }}" 
                    ...
                    class="w-full pl-10 pr-20 py-2.5 bg-white border border-gray-200 rounded-xl text-xs font-bold focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition shadow-2xs">
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-5 py-3.5 text-left text-[10px] font-black text-gray-500 uppercase tracking-wider">Asal Institusi</th>
                            <th scope="col" class="px-5 py-3.5 text-left text-[10px] font-black text-gray-500 uppercase tracking-wider">Lokasi Magang</th>
                            <th scope="col" class="px-5 py-3.5 text-right text-[10px] font-black text-gray-500 uppercase tracking-wider w-36">Aksi</th>
                        </tr>
                    </thead>
                        ...
                        <tr class="table-row hover:bg-gray-50/60 group">
                            ...
                            <td class="px-5 py-3.5 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3.5">
                                        <div class="text-sm font-bold text-gray-900 group-hover:text-teal-700 transition-colors">{{ $user->name }}</div>
                                        <div class="text-xs text-gray-500 mt-1 font-medium">{{ $user->email }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-5 py-3.5 whitespace-nowrap">
                                ...
                                @else
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-black uppercase bg-gray-100 text-gray-500 border border-gray-200">
                                        Belum Magang
                                    </span>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p class="text-sm font-bold text-gray-500">Belum ada peserta terdaftar.</p>
                ...
                <div class="p-4 space-y-3.5 hover:bg-gray-50/50 transition">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-gray-500 truncate mt-0.5">{{ $user->asal_instansi ?? 'Instansi (-)' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-3 rounded-xl border border-gray-100 text-xs text-gray-600 space-y-2">
                        <div>
                            ...
                            @if($user->applications->isNotEmpty())
                                <p class="text-xs font-bold text-gray-800 flex items-center leading-tight">
                    ...
                    <div class="pt-1">
                        ...
                        @else
                            <button disabled class="w-full px-4 py-2 bg-gray-100 text-gray-400 rounded-xl text-xs font-bold cursor-not-allowed border border-gray-200">
