                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-50">
                        ...
                        <div class="p-4 md:p-5 flex items-center justify-between feed-item hover:bg-gray-50 dark:hover:bg-gray-900/60 gap-3 md:gap-4">
                        ...
                        <div class="p-10 text-center">
                            ...
                            <p class="text-sm font-bold text-gray-500 dark:text-gray-400">Belum ada aktivitas lamaran</p>
