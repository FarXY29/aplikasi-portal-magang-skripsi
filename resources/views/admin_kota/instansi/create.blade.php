<x-app-layout>
    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900/50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="{{ route('admin.instansi.index') }}" class="inline-flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-teal-600 transition">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-600 flex items-center justify-center text-gray-300">
                                        <i class="fas fa-file-signature text-xl"></i>
                                    </div>
                                    <div class="flex-grow">
                                        <input type="file" name="ttd_kepala" accept="image/png, image/jpeg"
                                            class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-teal-600 file:text-white hover:file:bg-teal-700 cursor-pointer focus:outline-none border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
                            ...
                            <div class="md:col-span-2 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3 flex justify-between">
                                    ...
                                    <span class="text-blue-600 text-xs font-normal flex items-center"><i class="fas fa-mouse-pointer mr-1"></i> Klik pada peta untuk memindahkan pin</span>
                                </label>
...
<div class="mb-4">
                                    ...
                                    <div>
                                        <div class="relative">
                                            ...
                                            <input type="text" name="latitude" id="latitude" value="{{ old('latitude') }}"
                                                class="w-full pl-10 pr-4 py-2 rounded-lg border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 text-sm" 
                                    ...
                                    <div>
                                        <div class="relative">
                                            ...
                                            <input type="number" name="radius_absen" id="radius_absen" value="{{ old('radius_absen', 50) }}"
                                                class="w-full pl-10 pr-12 py-2 rounded-lg border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring focus:ring-blue-200 text-sm" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email_admin" value="{{ old('email_admin') }}"
                                        class="w-full pl-10 pr-4 py-3 rounded-xl border-gray-300 dark:border-gray-600 focus:border-orange-500 focus:ring focus:ring-orange-200 transition shadow-sm" 
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <a href="{{ route('admin.instansi.index') }}" class="px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl font-bold hover:bg-gray-200 transition">
                            Batal
                        </a>
