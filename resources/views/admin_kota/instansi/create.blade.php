                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-gray-700 mb-2">Nama Instansi<span class="text-red-500">*</span></label>
                                <div class="relative">
...
<div class="mb-4">
                                    ...
                                    <div>
                                        <div class="relative">
                                            ...
                                            <input type="number" name="radius_absen" id="radius_absen" value="{{ old('radius_absen', 50) }}"
                                                class="w-full pl-10 pr-12 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 text-sm" 
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-100">
                        <a href="{{ route('admin.instansi.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition">
                            Batal
                        </a>
