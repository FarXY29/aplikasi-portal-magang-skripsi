            ...
            <div class="bg-white shadow-xl sm:rounded-2xl overflow-hidden print:shadow-none print:rounded-none">
                <div class="p-8 print:p-0">
                    ...
                    <div class="mb-6 print:hidden border-b border-gray-100 pb-4">
                        ...
                        <p class="text-sm text-gray-500">Berikut adalah data seluruh Instansi yang terdaftar dalam sistem.</p>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 border border-gray-200">
                            <thead class="bg-gray-50 print:bg-gray-100">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider border">Nama Instansi</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="break-inside-avoid">
                                    ...
                                    <td class="px-4 py-3 text-sm font-semibold text-gray-900 border">{{ $instansi->nama_dinas }}</td>
                                    <td class="px-4 py-3 text-center text-sm text-gray-900 border">{{ $instansi->kode_unit_kerja }}</td>
                                    <td class="px-4 py-3 text-sm text-gray-700 border">{{ $instansi->alamat }}</td>
