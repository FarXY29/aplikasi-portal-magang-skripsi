    ...
    <div class="flex flex-col md:flex-row gap-6 max-w-6xl mx-auto my-auto px-4 sm:px-6">
        ...
        <div class="w-full md:w-5/12 bg-teal-600 rounded-3xl shadow-xl overflow-hidden relative flex flex-col justify-between p-8 md:p-12 min-h-[220px] md:min-h-[460px]">
            ...
            <div class="relative z-10 mt-8 md:mt-0 text-center md:text-left">
                <div class="w-16 h-16 sm:w-20 sm:h-20 bg-white/10 rounded-2xl flex items-center justify-center mb-5 backdrop-blur-md border border-white/20 shadow-inner mx-auto md:mx-0">
        ...
        <div class="w-full md:w-7/12 bg-white rounded-3xl shadow-xl overflow-hidden p-8 md:p-11 border border-gray-100 flex flex-col justify-center">
            
            <div class="mb-6">
                <h2 class="text-3xl font-extrabold text-gray-900 leading-tight">Masuk ke Akun</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="text" required autofocus
                            class="block w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-sm bg-gray-50 focus:bg-white transition placeholder-gray-400 shadow-sm font-medium"
                ...
                <div class="flex items-center pt-0.5">
                    <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                        ...
                        <span class="ml-2.5 text-sm text-gray-600 group-hover:text-gray-900 transition font-medium">Ingat saya</span>
                    </label>
                </div>
            ...
            <div class="relative my-8 sm:my-9">
                ...
                <div class="relative flex justify-center text-xs">
                    <span class="px-3.5 bg-white text-gray-400 text-xs font-medium uppercase tracking-wider">Atau masuk dengan</span>
                </div>
            </div>
