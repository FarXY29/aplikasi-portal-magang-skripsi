    ...
    <div class="flex flex-col md:flex-row gap-4 max-w-5xl mx-auto my-auto px-2 sm:px-6">
        ...
        <div class="w-full md:w-5/12 bg-teal-600 rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden relative flex flex-col justify-between p-6 sm:p-8 min-h-[160px] md:min-h-[420px]">
            ...
            <div class="relative z-10 mt-6 md:mt-0">
                <div class="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-4 backdrop-blur-md border border-white/20 shadow-inner">
        ...
        <div class="w-full md:w-7/12 bg-white rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden p-5 sm:p-7 border border-gray-100 flex flex-col justify-center">
            
            <div class="mb-4">
                <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 leading-tight">Buat Akun Baru</h2>
                <p class="mt-1 text-xs sm:text-sm text-gray-500" id="form-description">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3" id="registerForm">
                ...
                <!-- Pilihan Role -->
                <div>
                    <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1.5 ml-1">Mendaftar Sebagai</label>
                    <div class="grid grid-cols-2 gap-3">
                        <label class="cursor-pointer relative">
                            <input type="radio" name="role" value="peserta" class="peer sr-only" checked onchange="toggleRoleFields('peserta')">
                            <div class="rounded-xl border-2 border-gray-200 px-3.5 py-2 hover:bg-gray-50 peer-checked:border-teal-500 peer-checked:bg-teal-50 peer-checked:text-teal-700 transition">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Nama Lengkap</label>
                        <input id="name" name="name" type="text" required autofocus
                            class="block w-full px-3.5 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 text-xs sm:text-sm bg-gray-50 focus:bg-white transition font-medium"
                            placeholder="Sesuai KTP/KTM" value="{{ old('name') }}">
                        <x-input-error :messages="$errors->get('name')" class="mt-1" />
                    </div>
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Username</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Email</label>
                    ...
                    <div>
                        ...
                        <div id="field-peserta" class="{{ old('role') == 'pembimbing' ? 'hidden' : 'block' }}">
                            <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Jurusan / Program Studi</label>
                        ...
                        <div id="field-pembimbing" class="{{ old('role') == 'pembimbing' ? 'block' : 'hidden' }}">
                            <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Asal Sekolah / Kampus</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Password</label>
                    ...
                    <div>
                        <label class="block text-[11px] font-bold text-gray-700 uppercase mb-1 ml-1">Konfirmasi Password</label>
                ...
                <div class="relative my-3.5">
                    ...
                    <div class="relative flex justify-center text-xs">
                        <span class="px-3 bg-white text-gray-400 text-[11px] font-medium uppercase tracking-wider">Atau daftar dengan</span>
                    </div>
                </div>

                <div>
                    <a id="googleRegisterBtn" href="{{ route('google.login', ['role' => 'peserta']) }}" class="flex items-center justify-center w-full px-4 py-2.5 border border-gray-300 rounded-xl shadow-xs text-xs sm:text-sm font-bold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 transition transform hover:-translate-y-0.5">
                ...
                <div class="text-center pt-2.5 border-t border-gray-100 mt-3.5">
