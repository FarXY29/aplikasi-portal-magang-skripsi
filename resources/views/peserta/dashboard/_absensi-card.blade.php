...
<div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 flex flex-col justify-between stagger-2">
        ...
        <div class="flex items-center gap-3 sm:gap-4 mb-3">
            <div class="relative w-16 h-16 sm:w-20 sm:h-20 flex-shrink-0">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center rotate-90">
                    <span class="text-base sm:text-lg font-black text-teal-600 dark:text-teal-400 font-mono leading-none">{{ $stats['attendance']['hadir'] }}</span>
    ...
    <div class="mt-2 pt-3 border-t border-gray-100 dark:border-gray-700 text-center">
        <a href="{{ route('peserta.absensi.index') }}" class="inline-flex items-center gap-1.5 min-h-[44px] text-xs font-bold text-teal-600 hover:text-teal-800 dark:text-teal-400 dark:hover:text-teal-300 transition">
