                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <span class="p-2 bg-blue-50 dark:bg-blue-950/30 rounded-xl text-blue-600 dark:text-blue-400"><i class="fas fa-book"></i></span>
                            </div>
                            <div class="flex justify-between items-center gap-4 bg-gray-50 dark:bg-gray-900 p-3 rounded-xl border border-gray-200 dark:border-gray-700 mb-3">
                                <div>
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 pt-3 flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-teal-50 dark:bg-teal-950/30 flex items-center justify-center text-teal-600 dark:text-teal-400 font-bold border border-teal-100 dark:border-teal-900/50 text-xs">
