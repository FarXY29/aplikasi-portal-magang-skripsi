<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 class="font-extrabold text-2xl text-gray-800 dark:text-gray-200 leading-tight flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-950/60 flex items-center justify-center border border-indigo-200 dark:border-indigo-800/60">
                    <i class="fas fa-chalkboard-teacher text-indigo-600 dark:text-indigo-400 text-lg"></i>
                </div>
    ...
    <div class="py-8 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            @include('pembimbing_lapangan.partials._stats-grid', [
                'interns' => $interns,
                'pendingLogbooks' => $pendingLogbooks ?? 0,
            ...
            {{-- Daftar Mahasiswa Bimbingan Section --}}
            <section class="bg-white dark:bg-gray-800 rounded-3xl shadow-xs border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Pantau aktivitas, validasi kehadiran, dan berikan penilaian akhir.</p>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Periode & Status</th>
                                <th scope="col" class="px-6 py-4 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Kehadiran (Valid)</th>
                                <th scope="col" class="px-6 py-4 text-center text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nilai Akhir</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50 transition group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-indigo-900 dark:to-indigo-800 flex items-center justify-center text-indigo-700 dark:text-indigo-200 font-bold text-sm border border-indigo-200 dark:border-indigo-700 shadow-xs shrink-0">
                ...
                <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                    @forelse($interns as $mhs)
                    <article class="p-5 space-y-4 hover:bg-gray-50 dark:hover:bg-gray-900/50 transition">
                        {{-- Header Card: Foto, Nama, Email --}}
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-center gap-3">
                                <div class="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-indigo-900 dark:to-indigo-800 flex items-center justify-center text-indigo-700 dark:text-indigo-200 font-bold text-base border border-indigo-200 dark:border-indigo-700 shadow-xs shrink-0">
                                    {{ strtoupper(substr($mhs->user->name, 0, 1)) }}
                                </div>
                                <div>
                        ...
                        {{-- Periode & Stats Grid --}}
                        <div class="grid grid-cols-2 gap-2 bg-gray-50 dark:bg-gray-900 p-3 rounded-2xl border border-gray-100 dark:border-gray-700 text-xs">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2 pt-1">
                            <a href="{{ route('pembimbing_lapangan.logbook', $mhs->id) }}" 
                               class="w-full sm:flex-1 py-2.5 px-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-700 dark:text-gray-300 text-xs font-bold hover:bg-indigo-50 dark:hover:bg-indigo-950/30 hover:text-indigo-600 transition shadow-xs flex items-center justify-center gap-2">
                                <i class="fas fa-book-open text-indigo-500"></i> Cek Logbook
                            </a>

                            <a href="{{ route('pembimbing_lapangan.attendance.index') }}" 
                               class="w-full sm:flex-1 py-2.5 px-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-700 dark:text-gray-300 text-xs font-bold hover:bg-teal-50 dark:hover:bg-teal-950/30 hover:text-teal-600 transition shadow-xs flex items-center justify-center gap-2">
