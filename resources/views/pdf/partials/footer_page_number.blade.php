<script type="text/php">
    if (isset($pdf)) {
        ...
        $pdf->page_text($pdf->get_width() - 40 - $textWidth, $pdf->get_height() - 25, $pageText, $font, $size, [0.35, 0.35, 0.35]);
        ...
        $pdf->page_text(40, $pdf->get_height() - 25, $footerNote, $font, $size, [0.35, 0.35, 0.35]);
    }
</script>
