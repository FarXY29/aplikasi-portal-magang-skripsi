@php
    ...
    // Logo default Pemkot Banjarmasin
...
<table class="kop-surat" style="width: 100%; border: none; border-collapse: collapse; margin-bottom: 0;">
    <tr style="border: none;">
        <td style="width: 14%; border: none; padding: 0; text-align: center; vertical-align: middle;">
            @if($logoPath)
                <img src="{{ $logoPath }}" style="width: 72px; max-height: 78px; height: auto;" alt="Logo Pemkot">
            @endif
        </td>
        <td style="width: 86%; border: none; padding: 0 0 0 8px; text-align: center; vertical-align: middle;">
